! function(t, e) {
	...
	function l() {
		return xd || (xd = yd().getContext("2d")), xd
	}
	...
	function f(t, e, n) {
		if(t && e)
			if(t.forEach && t.forEach === dd) t.forEach(e, n);
	...
	function g(t, e, n, i) {
		if(t && e) {
			if(t.reduce && t.reduce === vd) return t.reduce(e, n, i);
	...
	function v(t, e, n) {
		if(t && e) {
			if(t.filter && t.filter === fd) return t.filter(e, n);
	...
	function b(t) {
		return "[object String]" === ud.call(t)
	}
	...
	function Oe(t, e) {
		qd && Le(qd, e), qd = Yd.put(t, qd || e.slice())
	}
	...
	function Be(t, e) {
		if(t) {
			...
			if(i in Ud) return Le(e, Ud[i]), Oe(t, e), e;
			if("#" !== i.charAt(0)) {
				var r = i.indexOf("("),
					a = i.indexOf(")");
				if(-1 !== r && a + 1 === i.length) {
	...
	function Fe(t, e, n) {
		if(e && e.length && t >= 0 && 1 >= t) {
			...
			var i = t * (e.length - 1),
				...
				s = e[a],
				l = i - r;
			return n[0] = Me(Ae(o[0], s[0], l)), n[1] = Me(Ae(o[1], s[1], l)), n[2] = Me(Ae(o[2], s[2], l)), n[3] = Te(Ae(o[3], s[3], l)), n
		}
	}
	...
	function He(t, e, n) {
		if(e && e.length && t >= 0 && 1 >= t) {
			var i = t * (e.length - 1),
				...
				s = Be(e[a]),
				l = i - r,
				h = We([Me(Ae(o[0], s[0], l)), Me(Ae(o[1], s[1], l)), Me(Ae(o[2], s[2], l)), Te(Ae(o[3], s[3], l))], "rgba");
			return n ? {
				color: h,
				leftIndex: r,
				rightIndex: a,
	...
	function Ze(t, e, n) {
		...
		if(i !== r) {
			...
			if(a) t.length = r;
				...
				for(var o = i; r > o; o++) t.push(1 === n ? e[o] : Qd.call(e[o]))
		}
	...
	function Je(t) {
		if(d(t)) {
			var e = t.length;
			if(d(t[0])) {
				for(var n = [], i = 0; e > i; i++) n.push(Qd.call(t[i]));
				return n
			}
			return Qd.call(t)
		}
	...
	function nn(t, e, n, i, r, a) {
		...
		if(h) {
			...
			for(var m = [], y = [], x = i[0].value, _ = !0, w = 0; h > w; w++) {
				m.push(i[w].time / u);
				var b = i[w].value;
				if(f && $e(b, x, v) || !f && b === x || (_ = !1), x = b, "string" == typeof b) {
					var S = Be(b);
					S ? (b = S, p = !0) : g = !0
				}
				y.push(b)
			...
			if(a || !_) {
				...
				var B = function(t, e) {
						...
						if(0 !== i)
							if(T = (e - m[n]) / i, l)
								if(D = y[n], C = y[0 === n ? n : n - 1], k = y[n > h - 2 ? h - 1 : n + 1], A = y[n > h - 3 ? h - 1 : n + 2], f) Ke(C, D, k, A, T, T * T, T * T * T, o(t, r), v);
								else {
									var a;
									if(p) a = Ke(C, D, k, A, T, T * T, T * T * T, O, 1), a = tn(O);
									else {
										if(g) return Ye(D, k, T);
										a = Qe(C, D, k, A, T, T * T, T * T * T)
									}
									s(t, r, a)
								}
	...
	function dn(t, e, n, i) {
		...
		if(!(2 > r)) {
			var a = 0;
			if(df > r) return a = on(t, n, i, e), void ln(t, n, i, n + a, e);
			var o = new cn(t, e),
				s = an(r);
			do {
				if(a = on(t, n, i, e), s > a) {
	...
	function xn(t, e, n, i, r) {
		if(t) {
			if("string" == typeof t) {
				...
				return a ? (e = a.image, !wn(e) && a.pending.push(o)) : (!e && (e = new Image), e.onload = _n, If.put(t, e.__cachedImgObj = {
					image: e,
					pending: [o]
	...
	function bn(t, e) {
		...
		return Cf > Df && (Cf = 0, Tf = {}), Cf++, Tf[n] = r, r
	}
	...
	function zn(t, e) {
		...
		for(var i, r = kf.lastIndex = 0; null != (i = kf.exec(t));) {
			var a = i.index;
			a > r && Rn(n, t.substring(r, a)), Rn(n, i[2], i[1]), r = kf.lastIndex
		}
		...
		for(var p = 0; p < o.length; p++) {
			for(var g = o[p], v = 0, m = 0, y = 0; y < g.tokens.length; y++) {
				var x = g.tokens[y],
					...
					S = x.textHeight = k(_.textHeight, On(b));
				...
				if("string" == typeof M && "%" === M.charAt(M.length - 1)) x.percentWidth = M, h.push(x), M = 0;
					...
					null != P && M > P && (!I || D > P ? (x.text = "", x.textWidth = M = 0) : (x.text = kn(x.text, P - D, b, c.ellipsis, {
						minChar: c.minChar
	...
	function Gn(t) {
		if(t) {
			t.font = Nn(t);
			var e = t.textAlign;
			"middle" === e && (e = "center"), t.textAlign = null == e || Lf[e] ? e : "left";
			var n = t.textVerticalAlign || t.textBaseline;
			"center" === n && (n = "middle"), t.textVerticalAlign = null == n || Of[n] ? n : "top";
			var i = t.textPadding;
	...
	function jn(t, e, n, i, r) {
		...
		for(var x = 0; x < n.lines.length; x++) {
			for(var _, w = n.lines[x], b = w.tokens, S = b.length, M = w.lineHeight, I = w.width, T = 0, C = v, D = y, k = S - 1; S > T && (_ = b[T], !_.textAlign || "left" === _.textAlign);) Yn(t, e, _, i, M, m, C, "left"), I -= _.width, C += _.width, T++;
			for(; k >= 0 && (_ = b[k], "right" === _.textAlign);) Yn(t, e, _, i, M, m, D, "right"), I -= _.width, D -= _.width, k--;
			for(C += (a - (C - v) - (y - D) - I) / 2; k >= T;) _ = b[T], Yn(t, e, _, i, M, m, C + _.width / 2, "center"), C += _.width, T++;
			m += M
		}
	}
	...
	function Zn(t, e, n, i, r, a, o) {
		...
		if(u) Qn(e, "fillStyle", s), e.fill();
			...
			var d = s.image;
			d = xn(d, null, t, $n, s), d && wn(d) && e.drawImage(d, i, r, a, o)
		}
	...
	function ri(t) {
		...
		this.style = new yf(t.style, this), this._rect = null, this.__clipPaths = []
	}
	...
	function li(t, e, n) {
		return Hf.copy(t.getBoundingRect()), t.transform && Hf.applyTransform(t.transform), Gf.width = e, Gf.height = n, !Hf.intersect(Gf)
	}
	...
	function fi(t, e, n, i) {
		return n = n || {}, i || !sd.canvasSupported ? pi(t, e, n) : sd.browser.firefox && null != e.layerX && e.layerX !== e.offsetX ? (n.zrX = e.layerX, n.zrY = e.layerY) : null != e.offsetX ? (n.zrX = e.offsetX, n.zrY = e.offsetY) : pi(t, e, n), n
	}
	...
	function gi(t, e, n) {
		...
		var o = e.button;
		return null == e.which && void 0 !== o && Xf.test(e.type) && (e.which = 1 & o ? 1 : 2 & o ? 3 : 4 & o ? 2 : 0), e
	}

	function vi(t, e, n) {
		Wf ? t.addEventListener(e, n) : t.attachEvent("on" + e, n)
	}

	function mi(t, e, n) {
		Wf ? t.removeEventListener(e, n) : t.detachEvent("on" + e, n)
	}
	...
	function _i(t) {
		return "mousewheel" === t && sd.browser.firefox ? "DOMMouseScroll" : t
	}
	...
	function Ii(t) {
		...
		kd.call(this), this.dom = t, this._touching = !1, this._touchTimer, this._gestureMgr = new Yf, this._handlers = {}, Mi(this), sd.pointerEventsSupported ? e(Jf, this) : (sd.touchEventsSupported && e(Kf, this), e($f, this))
	}
	...
	function Ci(t) {
		if(t) t.dispose();
			...
			for(var e in rp) rp.hasOwnProperty(e) && rp[e].dispose();
			rp = {}
		}
		return this
	}
	...
	function zi(t) {
		...
		lp(t, function(t) {
			...
			var i = t.exist,
				...
				a = t.keyInfo;
			if(hp(r)) {
				if(a.name = null != r.name ? r.name + "" : i ? i.name : cp + n, i) a.id = i.id;
	...
	function Ni(t) {
		return hp(t) && t.id && 0 === (t.id + "").indexOf("\x00_ec_\x00")
	}
	...
	function Hi() {
		var t = "__\x00ec_inner_" + fp++ + "_" + Math.random().toFixed(5);
		return function(e) {
			return e[t] || (e[t] = {})
		}
	}
	...
	function Gi(t, e, n) {
		...
		!r || Vi(e, r + "Index") || Vi(e, r + "Id") || Vi(e, r + "Name") || (e[r + "Index"] = 0);
		var a = {};
		return lp(e, function(i, r) {
			var i = e[r];
	...
	function Yi(t) {
		t.$constructor = t, t.extend = function(t) {
			...
			return o(n.prototype, t), n.extend = this.extend, n.superCall = Zi, n.superApply = $i, u(n, this), n.superClass = e, n
		}
	}

	function qi(t) {
		var e = ["__\x00is_clz", vp++, Math.random().toFixed(3)].join("_");
		...
		if(Qi(u) && Qi(c))
			...
			if(Qi(g)) {
				...
				var y = Sp(g),
					x = u * s + 1.5 * o * (-c + y),
					_ = u * s + 1.5 * o * (-c - y);
				x = 0 > x ? -bp(-x, Cp) : bp(x, Cp), _ = 0 > _ ? -bp(-_, Cp) : bp(_, Cp);
				var p = (-s - (x + _)) / (3 * o);
				p >= 0 && 1 >= p && (a[f++] = p)
			} else {
				var w = (2 * u * s - 3 * o * c) / (2 * Sp(u * u * u)),
					b = Math.acos(w) / 3,
					S = Sp(u),
					M = Math.cos(b),
					p = (-s - 2 * S * M) / (3 * o),
	...
	function ar(t, e, n, i, r, a, o, s, l, h, u) {
		var c, d, f, p, g, v = .005,
			m = 1 / 0;
		Dp[0] = l, Dp[1] = h;
		for(var y = 0; 1 > y; y += .05) kp[0] = tr(t, n, r, o, y), kp[1] = tr(e, i, a, s, y), p = Td(Dp, kp), m > p && (c = y, m = p);
		m = 1 / 0;
		for(var x = 0; 32 > x && !(Ip > v); x++) d = c - v, f = c + v, kp[0] = tr(t, n, r, o, d), kp[1] = tr(e, i, a, s, d), p = Td(kp, Dp), d >= 0 && m > p ? (c = d, m = p) : (Ap[0] = tr(t, n, r, o, f), Ap[1] = tr(e, i, a, s, f), g = Td(Ap, Dp), 1 >= f && m > g ? (c = f, m = g) : v *= .5);
		return u && (u[0] = tr(t, n, r, o, c), u[1] = tr(e, i, a, s, c)), Sp(m)
	}
	...
	function cr(t, e, n, i, r, a, o, s, l) {
		...
		for(var d = 0; 1 > d; d += .05) {
			kp[0] = or(t, n, r, d), kp[1] = or(e, i, a, d);
			var f = Td(Dp, kp);
			c > f && (h = d, c = f)
		}
		c = 1 / 0;
		for(var p = 0; 32 > p && !(Ip > u); p++) {
			var g = h - u,
				v = h + u;
			kp[0] = or(t, n, r, g), kp[1] = or(e, i, a, g);
			var f = Td(kp, Dp);
			if(g >= 0 && c > f) h = g, c = f;
			else {
				Ap[0] = or(t, n, r, v), Ap[1] = or(e, i, a, v);
				var m = Td(Ap, Dp);
				1 >= v && c > m ? (h = v, c = m) : u *= .5
			}
		}
		return l && (l[0] = or(t, n, r, h), l[1] = or(e, i, a, h)), Sp(c)
	}
	...
	function dr(t, e, n) {
		if(0 !== t.length) {
			var i, r = t[0],
				...
				s = r[1],
				l = r[1];
			for(i = 1; i < t.length; i++) r = t[i], a = Pp(a, r[0]), o = Lp(o, r[0]), s = Pp(s, r[1]), l = Lp(l, r[1]);
			e[0] = a, e[1] = s, n[0] = o, n[1] = l
		}
	}

	function fr(t, e, n, i, r, a) {
		r[0] = Pp(t, n), r[1] = Pp(e, i), a[0] = Lp(t, n), a[1] = Lp(e, i)
	}
	...
	function pr(t, e, n, i, r, a, o, s, l, h) {
		...
		for(l[0] = 1 / 0, l[1] = 1 / 0, h[0] = -1 / 0, h[1] = -1 / 0, u = 0; f > u; u++) {
			...
			l[0] = Pp(p, l[0]), h[0] = Lp(p, h[0])
		}
		for(f = c(e, i, a, s, Hp), u = 0; f > u; u++) {
			var g = d(e, i, a, s, Hp[u]);
			l[1] = Pp(g, l[1]), h[1] = Lp(g, h[1])
		}
		l[0] = Pp(t, l[0]), h[0] = Lp(t, h[0]), l[0] = Pp(o, l[0]), h[0] = Lp(o, h[0]), l[1] = Pp(e, l[1]), h[1] = Lp(e, h[1]), l[1] = Pp(s, l[1]), h[1] = Lp(s, h[1])
	}
	...
	function gr(t, e, n, i, r, a, o, s) {
		var l = hr,
			...
			d = h(t, n, r, u),
			f = h(e, i, a, c);
		o[0] = Pp(t, r, d), o[1] = Pp(e, a, f), s[0] = Lp(t, r, d), s[1] = Lp(e, a, f)
	}
	...
	function vr(t, e, n, i, r, a, o, s, l) {
		var h = oe,
			u = se,
			c = Math.abs(r - a);
		if(1e-4 > c % Ep && c > 1e-4) return s[0] = t - n, s[1] = e - i, l[0] = t + n, void(l[1] = e + i);
		if(zp[0] = Bp(r) * n + t, zp[1] = Op(r) * i + e, Rp[0] = Bp(a) * n + t, Rp[1] = Op(a) * i + e, h(s, zp, Rp), u(l, zp, Rp), r %= Ep, 0 > r && (r += Ep), a %= Ep, 0 > a && (a += Ep), r > a && !o ? a += Ep : a > r && o && (r += Ep), o) {
			var d = a;
			a = r, r = d
		}
		for(var f = 0; a > f; f += Math.PI / 2) f > r && (Np[0] = Bp(f) * n + t, Np[1] = Op(f) * i + e, h(s, Np, s), u(l, Np, l))
	}
	...
	function wr(t, e, n, i, r, a, o, s, l) {
		...
		if(Math.abs(i - r) % eg < 1e-4) return !0;
		if(a) {
			var c = i;
			i = _r(r), r = _r(c)
		} else i = _r(i), r = _r(r);
		...
		return 0 > d && (d += eg), d >= i && r >= d || d + eg >= i && r >= d + eg
	}
		...
		for(var c = 0, d = 0; 2 > d; d++) {
			...
			if(f + t > o) {
				var p = Math.atan2(s, f),
					u = a ? 1 : -1;
				0 > p && (p = ig + p), (p >= i && r >= p || p + ig >= i && r >= p + ig) && (p > Math.PI / 2 && p < 1.5 * Math.PI && (u = -u), c += u)
			}
		}
		return c
	}
	...
	function Dr(t, e, n, i, r) {
		for(var a = 0, o = 0, s = 0, l = 0, h = 0, u = 0; u < t.length;) {
			var c = t[u++];
			switch(c === ng.M && u > 1 && (n || (a += br(o, s, l, h, i, r))), 1 == u && (o = t[u], s = t[u + 1], l = o, h = s), c) {
				case ng.M:
					l = t[u++], h = t[u++], o = l, s = h;
					break;
				case ng.L:
	...
	function Lr(t, e, n, i, r, a, o, s, l, h, u) {
		var c = l * (xg / 180),
			d = yg(c) * (t - n) / 2 + mg(c) * (e - i) / 2,
			f = -1 * mg(c) * (t - n) / 2 + yg(c) * (e - i) / 2,
			p = d * d / (o * o) + f * f / (s * s);
		p > 1 && (o *= vg(p), s *= vg(p));
		var g = (r === a ? -1 : 1) * vg((o * o * s * s - o * o * f * f - s * s * d * d) / (o * o * f * f + s * s * d * d)) || 0,
			v = g * o * f / s,
			m = g * -s * d / o,
			y = (t + n) / 2 + yg(c) * v - mg(c) * m,
			x = (e + i) / 2 + mg(c) * v + yg(c) * m,
			_ = bg([1, 0], [(d - v) / o, (f - m) / s]),
			w = [(d - v) / o, (f - m) / s],
			b = [(-1 * d - v) / o, (-1 * f - m) / s],
			S = bg(w, b);
		wg(w, b) <= -1 && (S = xg), wg(w, b) >= 1 && (S = 0), 0 === a && S > 0 && (S -= 2 * xg), 1 === a && 0 > S && (S += 2 * xg), u.addData(h, y, x, o, s, _, S, c, a)
	}
	...
	function Fr(t, e, n) {
		...
		if(i && i.length >= 2) {
			if(r && "spline" !== r) {
				...
				"spline" === r && (i = kg(i, n)), t.moveTo(i[0][0], i[0][1]);
	...
	function Xr(t, e, n, i) {
		var r = Er(t, e),
			a = r.getBoundingRect();
		return n && ("center" === i && (n = Ur(n, a)), Yr(r, n)), r
	}
	...
	function qr(t) {
		var e = t.shape,
			n = t.style.lineWidth;
		return Wg(2 * e.x1) === Wg(2 * e.x2) && (e.x1 = e.x2 = $r(e.x1, n, !0)), Wg(2 * e.y1) === Wg(2 * e.y2) && (e.y1 = e.y2 = $r(e.y1, n, !0)), t
	}
	...
	function $r(t, e, n) {
		var i = Wg(2 * t);
		return(i + Wg(e)) % 2 === 0 ? i / 2 : (i + (n ? 1 : -1)) / 2
	}
	...
	function ga(t, e, n, i, r, a) {
		if(n = !r && n || Ug, t.textFill = va(e.getShallow("color"), i) || n.color, t.textStroke = va(e.getShallow("textBorderColor"), i) || n.textBorderColor, t.textStrokeWidth = k(e.getShallow("textBorderWidth"), n.textBorderWidth), !r) {
			if(a) {
	...
	function Ma(t, e, n) {
		return e && !d(e) && (e = Rd.getLocalTransform(e)), n && (e = _e([], e)), ae([], t, e)
	}
	...
	function Ca(t, e) {
		return p(t, function(t) {
			var n = t[0];
			n = Xg(n, e.x), n = jg(n, e.x + e.width);
			var i = t[1];
			return i = Xg(i, e.y), i = jg(i, e.y + e.height), [n, i]
		})
	}
	...
	function Da(t, e) {
		var n = Xg(t.x, e.x),
			...
			r = Xg(t.y, e.y),
			a = jg(t.y + t.height, e.y + e.height);
		return i >= n && a >= r ? {
			x: n,
			y: r,
			width: i - n,
	...
	function no(t, e, n) {
		...
		for(var s = 0; i > s; s++)
			for(var l = 0; l < r.length; l++) {
				var h = e[s][r[l]];
				t = t.replace(lv(sv[l], s), n ? eo(h) : h)
			}
		return t
	}
	...
	function po(t) {
		var e = [];
		return f(yv.getClassesByMainType(t), function(t) {
	...
	function yo(t) {
		this.fromDataset = t.fromDataset, this.data = t.data || (t.sourceFormat === Cv ? {} : []), this.sourceFormat = t.sourceFormat || Dv, this.seriesLayoutBy = t.seriesLayoutBy || Av, this.dimensionsDefine = t.dimensionsDefine, this.encodeDefine = t.encodeDefine && N(t.encodeDefine), this.startIndex = t.startIndex || 0, this.dimensionsDetectCount = t.dimensionsDetectCount
	}
	...
	function wo(t) {
		...
		if(l) {
			var h = l.option;
			n = h.source, i = Lv(l).sourceFormat, r = !0, a = a || h.seriesLayoutBy, null == o && (o = h.sourceHeader), s = s || h.dimensions
		}
		var u = bo(n, i, a, o, s),
			c = e.encode;
		!c && l && (c = To(t, l, n, i, a, u)), Lv(t).source = new yo({
			data: n,
			fromDataset: r,
			seriesLayoutBy: a,
			sourceFormat: i,
	...
	function bo(t, e, n, i, r) {
		if(!t) return {
			dimensionsDefine: So(r)
		};
		var a, o, s;
		if(e === Iv) "auto" === i || null == i ? Mo(function(t) {
			null != t && "-" !== t && (b(t) ? null == o && (o = 1) : o = 0)
		}, n, t, 10) : o = i ? 1 : 0, r || 1 !== o || (r = [], Mo(function(t, e) {
			r[e] = null != t ? t : ""
		}, n, t)), a = r ? r.length : n === Pv ? t.length : t[0] ? t[0].length : null;
		else if(e === Tv) r || (r = Io(t), s = !0);
		else if(e === Cv) r || (r = [], s = !0, f(t, function(t, e) {
			r.push(e)
		}));
		else if(e === Mv) {
			var l = Oi(t[0]);
	...
	function ko(t, e, n, i, r, a) {
		...
		if(I(t)) return !1;
		var h;
		if(i && (h = i[a], h = S(h) ? h.name : h), e === Iv)
			if(n === Pv) {
	...
	function Po(t, e) {
		...
		f(e, function(e, a) {
			"colorLayer" === a && n || yv.hasClass(a) || ("object" == typeof e ? t[a] = t[a] ? r(t[a], e, !1) : i(e) : null == t[a] && (t[a] = e))
		})
	}

	function Lo(t) {
		t = t, this.option = {}, this.option[Ov] = 1, this._componentsMap = N({
			series: []
		}), this._seriesIndices, this._seriesIndicesMap, Po(t, this._theme.option), r(t, _v, !1), this.mergeOption(t)
	}
	...
	function Bo(t, e, n) {
		var i = e.type ? e.type : n ? n.subType : yv.determineSubType(t, e);
		return i
	}
		...
		e = e || {}, Rv(e, function(e, n) {
			if(null != e) {
				...
				if(yv.hasClass(n)) {
					...
					var r = Ei(i, e);
					t[n] = Fv(r, function(t) {
						return t.option && t.exist ? Hv(t.exist, t.option, !0) : t.exist || t.option
					})
				} else t[n] = Hv(i, e, !0)
			}
		})
	...
	function Zo(t) {
		t && (Yo(t), qo(t, "label"), t.emphasis && qo(t.emphasis, "label"))
	}

	function $o(t) {
		if(Wv(t)) {
			jo(t), Yo(t), qo(t, "label"), qo(t, "upperLabel"), qo(t, "edgeLabel"), t.emphasis && (qo(t.emphasis, "label"), qo(t.emphasis, "upperLabel"), qo(t.emphasis, "edgeLabel"));
			var e = t.markPoint;
			e && (jo(e), Zo(e));
			var n = t.markLine;
			n && (jo(n), Zo(n));
			...
			if("graph" === t.type) {
				...
				if(a && !I(a))
					for(var o = 0; o < a.length; o++) Zo(a[o]);
				f(t.categories, function(t) {
					Yo(t)
				})
			}
			if(r && !I(r))
				for(var o = 0; o < r.length; o++) Zo(r[o]);
			var e = t.markPoint;
			if(e && e.data)
				for(var s = e.data, o = 0; o < s.length; o++) Zo(s[o]);
			var n = t.markLine;
			if(n && n.data)
				for(var l = n.data, o = 0; o < l.length; o++) _(l[o]) ? (Zo(l[o][0]), Zo(l[o][1])) : Zo(l[o]);
			"gauge" === t.type ? (qo(t, "axisLabel"), qo(t, "title"), qo(t, "detail")) : "treemap" === t.type && (Uo(t.breadcrumb, "itemStyle"), f(t.levels, function(t) {
				Yo(t)
			}))
		}
	}
	...
	function is(t, e) {
		...
		var r = Kv[i === Iv ? i + "_" + t.seriesLayoutBy : i];
		o(this, r)
	}
	...
	function ls(t, e, n, i) {
		return hs(t[i], this._dimensionInfos[e])
	}
	...
	function us(t, e, n) {
		if(t) {
			...
			if(null != i) {
				...
				return s && (r = s.name, a = s.index), Qv[o](i, e, a, r)
			}
		}
	}
	...
	function cs(t, e, n) {
		if(t) {
			...
			if(i === Mv || i === Tv) {
				...
				return i !== Mv || S(r) || (r = null), r ? r[n] : void 0
			}
		}
	}
	...
	function ps(t, e) {
		...
		var n, i;
		!e && t._reset && (n = t._reset(t.context), n && n.progress && (i = n.forceFirstProgress, n = n.progress)), t._progress = n;
		var r = t._downstream;
		return r && r.dirty(), i
	}
	...
	function ys(t) {
		var e = t.model;
		return e.setData(e.getRawData().cloneShallow()), xs
	}
	...
	function Ss() {
		this.group = new cf, this.uid = Oa("viewChart"), this.renderTask = ds({
			plan: Ts,
			reset: Cs
	...
	function Ms(t, e) {
		if(t && (t.trigger(e), "group" === t.type))
			for(var n = 0; n < t.childCount(); n++) Ms(t.childAt(n), e)
	}

	function Is(t, e, n) {
		var i = Fi(t, e);
		null != i ? f(Pi(i), function(e) {
			Ms(t.getItemGraphicEl(e), n)
	...
	function Cs(t) {
		var e = t.model,
			...
			o = t.view,
			s = r && lm(r).updateMethod,
			l = a ? "incrementalPrepareRender" : s && o[s] ? s : "render";
		return "render" !== l && o[l](e, n, i, r), cm[l]
	}
	...
	function ks(t, e, n, i) {
		...
		if(r) {
			...
			if(s !== n || o !== i) {
				...
				r = t[e] = Ds(a, n, "debounce" === i), r[dm] = a, r[pm] = i, r[fm] = n
			}
			return r
		}
	}
	...
	function As(t, e, n, i) {
		this.ecInstance = t, this.api = e, this.unfinished, this._dataProcessorHandlers = n.slice(), this._visualHandlers = i.slice(), this._stageTaskMap = N()
	}
		...
		f(e, function(e) {
			if(!r.visualType || r.visualType === e.visualType) {
				...
				if(h) {
					...
					l.skip = !e.performRawSeries && n.isSeriesFiltered(s.context.model), wm(s, i), o |= s.perform(l)
				})
			}
		}), t.unfinished |= o
	}
	...
	function Os(t, e, n, i, r) {
		function a(e) {
			...
			i.context = {
				...
				overallProgress: u,
				isOverallFilter: c
			}, i.agent = o, i.__block = u, Vs(t, e, i)
		}
		var o = n.overallTask = n.overallTask || ds({
			reset: Bs
		});
		o.context = {
			ecModel: i,
		...
		s.each(function(t, e) {
			d.get(e) || (t.dispose(), s.removeKey(e))
		})
	}
	...
	function Hs(t, e) {
		for(var n = e.data, i = e.resetDefines, r = 0; r < i.length; r++) {
			var a = i[r];
			if(a && a.dataEach)
				for(var o = t.start; o < t.end; o++) a.dataEach(n, o);
	...
	function js(t) {
		return function(e, n, i) {
			e = e && e.toLowerCase(), kd.prototype[t].call(this, e, n, i)
		}
	}
	...
	function Ys(t, e, n) {
		...
		n = n || {}, "string" == typeof e && (e = ay[e]), this.id, this.group, this._dom = t;
		var a = "canvas",
			o = this._zr = Ti(t, {
		...
		this._throttledZrFlush = Ds(y(o.flush, o), 17);
		var e = i(e);
		e && qv(e, !0), this._theme = e, this._chartsViews = [], this._chartsMap = {}, this._componentsViews = [], this._componentsMap = {}, this._coordSysMgr = new No;
		var s = this._api = cl(this);
		dn(ry, r), dn(ey, r), this._scheduler = new As(this, s, ey, ry), kd.call(this), this._messageCenter = new Us, this._initEvents(), this.resize = y(this.resize, this), this._pendingActions = [], o.animation.on("frame", this._onframe, this), el(o, this), E(this)
	}
	...
	function $s(t, e, n, i, r) {
		...
		var o = t._model;
		if(!i) return void Lm(t._componentsViews.concat(t._chartsViews), a);
		var s = {};
	...
	function Qs(t, e) {
		...
		Lm(u, function(t) {
			d = r.action(t, this._model, this._api), d = d || o({}, t), d.type = a.event || d.type, f.push(d), g ? $s(this, h, t, "series") : l && $s(this, h, t, l.main, l.sub)
		}, this), "none" === h || g || l || (this[qm] ? (Zs(this), Km.update.call(this, t), this[qm] = !1) : Km[h].call(this, t)), d = c ? {
			type: a.event || n,
			escapeConnect: i,
			batch: f
		} : f[0], this[Ym] = !1, !e && this._messageCenter.trigger(d.type, d)
	}
	...
	function el(t, e) {
		t.on("rendered", function() {
			e.trigger("rendered"), !t.animation.isFinished() || e[qm] || e._scheduler.unfinished || e._pendingActions.length || e.trigger("finished")
		})
	}
	...
	function nl(t, e, n, i) {
		function r(t) {
			...
			if(!r) {
				var u = Em(t.type),
					c = a ? am.getClass(u.main, u.sub) : Ss.getClass(u.sub);
	...
	function rl(t, e, n, i) {
		al(t, e, n, i), Lm(t._chartsViews, function(t) {
			t.__alive = !1
		}), ol(t, e, n, i), Lm(t._chartsViews, function(t) {
	...
	function ol(t, e, n, i, r) {
		...
		e.eachSeries(function(e) {
			...
			n.__alive = !0;
			var s = n.renderTask;
			o.updatePayload(s, i), r && r.get(e.uid) && s.dirty(), a |= s.perform(o.getPerformArgs(s)), n.group.silent = !!e.get("silent"), ul(e, n), hl(e, n)
		}), o.unfinished |= a, ll(t._zr, e), mm(t._zr.dom, e)
	}
	...
	function ll(t, e) {
		...
		n.traverse(function(t) {
			t.isGroup || i++
		}), i > e.get("hoverLayerThreshold") && !sd.node && n.traverse(function(t) {
	...
	function fl(t, e, n) {
		...
		if(i) return i;
		var r = new Ys(t, e, n);
		return r.id = "ec_" + hy++, sy[r.id] = r, Wi(t, cy, r.id), dl(r), r
	}
	...
	function vl(t) {
		"string" == typeof t ? t = sy[t] : t instanceof Ys || (t = ml(t)), t instanceof Ys && !t.isDisposed() && t.dispose()
	}
	...
	function Sl(t, e, n) {
		...
		t.event = (t.event || i).toLowerCase(), e = t.event, Pm(Zm.test(i) && Zm.test(e)), Jm[i] || (Jm[i] = {
			action: n,
			actionInfo: t
		}), ty[e] = i
	}
	...
	function El(t, e, n) {
		e.geoJson && !e.features && (n = e.specialAreas, e = e.geoJson), "string" == typeof e && (e = "undefined" != typeof JSON && JSON.parse ? JSON.parse(e) : new Function("return (" + e + ");")()), dy[t] = {
			geoJson: e,
			specialAreas: n
		}
	}
	...
	function Nl(t, e, n, i, r) {
		this._old = t, this._new = e, this._oldKeyGetter = n || Rl, this._newKeyGetter = i || Rl, this.context = r
	}
	...
	function Hl(t) {
		...
		f(t.dimensions, function(e) {
			...
			if(o) {
				var s = n[o];
				n.hasOwnProperty(o) || (s = n[o] = []), s[a.coordDimIndex] = e, a.isExtraCoord || (i.set(o, 1), Vl(a.type) && (r[0] = e))
			}
			gy.each(function(t, e) {
				var i = n[e];
				n.hasOwnProperty(e) || (i = n[e] = []);
				var r = a.otherDims[e];
				null != r && r !== !1 && (i[r] = a.name)
			})
		});
		var a = [],
			o = {};
		i.each(function(t, e) {
			var i = n[e];
			o[e] = i[0], a = a.concat(i)
		}), e.dataDimsOnCoord = a, e.encodeFirstDimNotExtra = o;
		var s = n.label;
		s && s.length && (r = s.slice());
		var l = r.slice(),
			h = n.tooltip;
		return h && h.length && (l = h.slice()), n.defaultedLabel = r, n.defaultedTooltip = l, e
	}
	...
	function Wl(t) {
		return t._rawCount > 65535 ? wy : by
	}
	...
	function jl(t, e) {
		f(Sy.concat(e.__wrappedMethods || []), function(n) {
			e.hasOwnProperty(n) && (t[n] = e[n])
	...
	function Ul(t) {
		...
		f(e, function(n, i) {
			var r = t._dimensionInfos[i],
				a = r.ordinalMeta;
			if(a) {
				n = e[i] = new wy(a.categories.length);
	...
	function Zl(t, e) {
		var n = t._idList[e];
		return null == n && (n = t._getIdFromStore(e)), null == n && (n = xy + e), n
	}
	...
	function Kl(t, e) {
		var n = t.dimensions,
			i = new My(p(n, t.getDimensionInfo, t), t.hostModel);
		jl(i, t);
		for(var r = i._storage = {}, a = t._storage, s = o({}, t._rawExtent), l = 0; l < n.length; l++) {
			var u = n[l];
			a[u] && (h(e, u) >= 0 ? (r[u] = Ql(a[u]), s[u] = Jl()) : r[u] = a[u])
		}
		return i
	}

	function Ql(t) {
		for(var e = new Array(t.length), n = 0; n < t.length; n++) e[n] = Xl(t[n]);
		return e
	}
	...
	function th(t, e, n) {
		function r(t, e, n) {
			null != gy.get(e) ? t.otherDims[e] = n : (t.coordDim = e, t.coordDimIndex = n, u.set(e, !0))
		}
		yo.isInstance(e) || (e = yo.seriesDataToSource(e)), n = n || {}, t = (t || []).slice();
		for(var a = (n.dimsDef || []).slice(), l = N(n.encodeDef), h = N(), u = N(), c = [], d = eh(e, t, a, n.dimCount), p = 0; d > p; p++) {
		...
		f(t, function(t) {
			...
			f(h, function(i, o) {
				var l = c[i];
				r(s(l, t), e, o), null == l.name && n && (l.name = l.displayName = n[o]), a && s(l.otherDims, a)
			})
		});
		...
		for(var M = x || "value", I = 0; d > I; I++) {
			var m = c[I] = c[I] || {},
				T = m.coordDim;
			null == T && (m.coordDim = nh(M, u, w), m.coordDimIndex = 0, (!x || 0 >= _) && (m.isExtraCoord = !0), _--), null == m.name && (m.name = nh(m.coordDim, h)), null == m.type && Do(e, I, m.name) && (m.type = "ordinal")
		}
		return c
	}
	...
	function ah(t, e, n) {
		...
		var d = null != s && oh(t) ? function(t, e, n, i) {
	...
	function dh(t, e, n, i) {
		...
		var s = r.intervalPrecision = fh(o),
			l = r.niceTickExtent = [Py(Math.ceil(t[0] / o) * o, s), Py(Math.floor(t[1] / o) * o, s)];
		return gh(l, t), r
	}
	...
	function vh(t, e, n, i) {
		...
		var a = 1e4;
		e[0] < n[0] && r.push(e[0]);
		for(var o = n[0]; o <= n[1] && (r.push(o), o = Py(o + t, i), o !== r[r.length - 1]);)
			if(r.length > a) return [];
		return e[1] > (r.length ? r[r.length - 1] : n[1]) && r.push(e[1]), r
	}

	function mh(t) {
		return t.get("stack") || By + t.seriesIndex
	}
	...
	function xh(t, e) {
		var n = p(t, function(t) {
			var e = t.getData(),
				...
				o = Na(t.get("barWidth"), a),
				s = Na(t.get("barMaxWidth"), a),
				l = t.get("barGap"),
	...
	function wh(t, e) {
		...
		f(n, function(t) {
			...
			for(var d = e.mapDimension(u.dim), f = e.mapDimension(a.dim), p = rh(e, d, f), g = u.isHorizontal(), v = a.onZero || p ? u.toGlobalCoord(u.dataToCoord(0)) : u.getGlobalExtent()[0], m = 0, y = e.count(); y > m; m++) {
				var x = e.get(d, m),
					_ = e.get(f, m);
				if(!isNaN(x)) {
					var w = x >= 0 ? "p" : "n",
	...
	function Sh(t, e) {
		var n, i, r, a = t.type,
			...
			h = null != s,
			u = t.getExtent();
		"ordinal" === a ? n = e.getCategories().length : (i = e.get("boundaryGap"), _(i) || (i = [i || 0, i || 0]), "boolean" == typeof i[0] && (i = [0, 0]), i[0] = Na(i[0], 1), i[1] = Na(i[1], 1), r = u[1] - u[0] || Math.abs(u[0])), null == o && (o = "ordinal" === a ? n ? 0 : 0 / 0 : u[0] - i[0] * r), null == s && (s = "ordinal" === a ? n ? n - 1 : 0 / 0 : u[1] + i[1] * r), "dataMin" === o ? o = u[0] : "function" == typeof o && (o = o({
			min: u[0],
			max: u[1]
		})), "dataMax" === s ? s = u[1] : "function" == typeof s && (s = s({
			min: u[0],
			max: u[1]
		})), (null == o || !isFinite(o)) && (o = 0 / 0), (null == s || !isFinite(s)) && (s = 0 / 0), t.setBlank(C(o) || C(s)), e.getNeedCrossZero() && (o > 0 && s > 0 && !l && (o = 0), 0 > o && 0 > s && !h && (s = 0));
		var c = e.ecModel;
		if(c && "time" === a) {
			var d, f = [];
	...
	function Th(t, e) {
		if(e = e || t.get("type")) switch(e) {
			case "category":
				return new Ay(t.getOrdinalMeta ? t.getOrdinalMeta() : t.getCategories(), [1 / 0, -1 / 0]);
			case "value":
				return new Oy;
			default:
				return(lh.getClass(e) || Oy).create(t)
		}
	}
	...
	function Lh(t, e, n, i, r, a, o) {
		var s = 0 === t.indexOf("empty");
		s && (t = t.substr(5, 1).toLowerCase() + t.substr(6));
		var l;
		return l = 0 === t.indexOf("image://") ? jr(t.slice(8), new rn(e, n, i, r), o ? "center" : "cover") : 0 === t.indexOf("path://") ? Xr(t.slice(7), {}, new rn(e, n, i, r), o ? "center" : "cover") : new lx({
			shape: {
				symbolType: t,
				x: e,
				y: n,
		...
		}), l.__isEmptyBrush = s, l.setColor = Ph, l.setColor(a), l
	}

	function Oh(t) {
		return ah(t.getSource(), t)
	}

	function Bh(t, e) {
		var n = e;
		Aa.isInstance(e) || (n = new Aa(e), c(n, tx));
		var i = Th(n);
		return i.setExtent(t[0], t[1]), Ih(i, n), i
	}
	...
	function Rh(t, e, n) {
		...
		var s = t[0];
		return zh(r[0], s[0]) && zh(r[1], s[1]) || (i += br(r[0], r[1], s[0], s[1], e, n)), 0 !== i
	}
	...
	function Fh(t) {
		...
		for(var n = t.features, i = 0; i < n.length; i++)
			for(var r = n[i], a = r.geometry, o = a.coordinates, s = a.encodeOffsets, l = 0; l < o.length; l++) {
				var h = o[l];
				if("Polygon" === a.type) o[l] = Hh(h, s[l], e);
	...
	function $h(t) {
		return "category" === t.type || "time" === t.type || !Dx(t)
	}
	...
	function eu(t, e, n, i, r, a) {
		var o = n.getModel("label"),
			s = n.getModel("emphasis.label");
		ua(t, e, o, s, {
			labelFetcher: r,
			labelDataIndex: a,
			defaultText: tu(r.getData(), a),
			isRectText: !0,
			autoColor: i
		}), nu(t), nu(e)
	}
	...
	function au(t, e, n, i, r, a, o, l) {
		...
		l || eu(t.style, d, i, h, a, n, p), ha(t, d)
	}
	...
	function lu(t, e, n, i) {
		...
		return Ua(o - Nx / 2) ? (a = l ? "bottom" : "top", r = "center") : Ua(o - 1.5 * Nx) ? (a = l ? "top" : "bottom", r = "center") : (a = "middle", r = 1.5 * Nx > o && o > Nx / 2 ? l ? "left" : "right" : l ? "right" : "left"), {
			rotation: o,
			textAlign: r,
			textVerticalAlign: a
		}
	...
	function uu(t, e, n) {
		...
		var a = e[0],
			...
			c = n[n.length - 1],
			d = n[n.length - 2];
		i === !1 ? (cu(a), cu(h)) : du(a, o) && (i ? (cu(o), cu(u)) : (cu(a), cu(h))), r === !1 ? (cu(s), cu(c)) : du(l, s) && (r ? (cu(l), cu(d)) : (cu(s), cu(c)))
	}
	...
	function pu(t, e, n) {
		...
		if(e.get("axisTick.show") && !i.scale.isBlank()) {
			for(var r = e.getModel("axisTick"), a = r.getModel("lineStyle"), o = r.get("length"), l = Wx(r, n.labelInterval), h = i.getTicksCoords(r.get("alignWithLabel")), u = i.scale.getTicks(), c = e.get("axisLabel.showMinLabel"), d = e.get("axisLabel.showMaxLabel"), f = [], p = [], g = t._transform, v = [], m = h.length, y = 0; m > y; y++)
				if(!Vx(i, y, l, m, c, d)) {
					var x = h[y];
					f[0] = x, f[1] = 0, p[0] = x, p[1] = n.tickDirection * o, g && (ae(f, f, g), ae(p, p, g));
					var _ = new Bg(qr({
						anid: "tick_" + u[y],
						shape: {
							x1: f[0],
	...
	function gu(t, e, n) {
		...
		if(r && !i.scale.isBlank()) {
			var a = e.getModel("axisLabel"),
				...
				h = (D(n.labelRotate, a.get("rotate")) || 0) * Nx / 180,
				u = Gx(n.rotation, h, n.labelDirection),
				c = e.getCategories(),
				d = [],
				p = hu(e),
			...
			return f(s, function(r, h) {
				if(!Vx(i, h, n.labelInterval, s.length, v, m)) {
					var f = a;
					c && c[r] && c[r].textStyle && (f = new Aa(c[r].textStyle, a, e.ecModel));
					var y = f.getTextColor() || e.get("axisLine.lineStyle.color"),
						x = i.dataToCoord(r),
						_ = [x, n.labelOffset + n.labelDirection * o],
					...
					ca(b.style, f, {
						text: l[h],
						textAlign: f.getShallow("align", !0) || u.textAlign,
						textVerticalAlign: f.getShallow("verticalAlign", !0) || f.getShallow("baseline", !0) || u.textVerticalAlign,
						textFill: "function" == typeof y ? y("category" === i.type ? w : "value" === i.type ? r + "" : r, h) : y
					}), g && (b.eventData = su(e), b.eventData.targetType = "axisLabel", b.eventData.value = w), t._dumbGroup.add(b), b.updateTransform(), d.push(b), t.group.add(b), b.decomposeTransform()
				}
			}), d
		}
	}
	...
	function vu(t, e) {
		...
		return mu(n, t, e), n.seriesInvolved && xu(n, t), n
	}
	...
	function mu(t, e, n) {
		var i = e.getComponent("tooltip"),
			...
			a = r.get("link", !0) || [],
			o = [];
		Xx(n.getCoordinateSystems(), function(n) {
			function s(i, s, l) {
				var u = l.model.getModel("axisPointer", r),
					d = u.get("show");
				if(d && ("auto" !== d || i || Iu(u))) {
					null == s && (s = u.get("triggerTooltip")), u = i ? yu(l, c, r, e, i, s) : u;
					var f = u.get("snap"),
						p = Tu(l.model),
			...
			if(n.axisPointerEnabled) {
				...
				if(Xx(n.getAxes(), jx(s, !1, null)), n.getTooltipAxes && i && c.get("show")) {
					var d = "axis" === c.get("trigger"),
						f = "cross" === c.get("axisPointer.type"),
						p = n.getTooltipAxes(c.get("axisPointer.axis"));
					(d || f) && Xx(p.baseAxes, jx(s, f ? "cross" : !0, d)), f && Xx(p.otherAxes, jx(s, "cross", !1))
				}
			}
		})
	}

	function yu(t, e, n, r, a, o) {
		var l = e.getModel("axisPointer"),
			h = {};
		Xx(["type", "snap", "lineStyle", "shadowStyle", "label", "animation", "animationDurationUpdate", "animationEasingUpdate", "z"], function(t) {
			h[t] = i(l.get(t))
	...
	function xu(t, e) {
		e.eachSeries(function(e) {
			...
			n && "none" !== i && i !== !1 && "item" !== i && r !== !1 && e.get("axisPointer.show", !0) !== !1 && Xx(t.coordSysAxesInfo[Tu(n.model)], function(t) {
				var i = t.axis;
	...
	function _u(t, e) {
		for(var n = e.model, i = e.dim, r = 0; r < t.length; r++) {
			var a = t[r] || {};
			if(wu(a[i + "AxisId"], n.id) || wu(a[i + "AxisIndex"], n.componentIndex) || wu(a[i + "AxisName"], n.name)) return r
		}
	}
	...
	function Cu(t, e, n, i, r, a) {
		var o = Ux.getAxisPointerClass(t.axisPointerClass);
		if(o) {
			var s = Mu(e);
			s ? (t._axisPointer || (t._axisPointer = new o)).render(e, s, i, a) : Du(t, i)
		}
	}
	...
	function ku(t, e, n) {
		...
		a.labelDirection = a.tickDirection = a.nameDirection = v[o], a.labelOffset = r.onZero ? f[c[o]] - f[c.onZero] : 0, e.get("axisTick.inside") && (a.tickDirection = -a.tickDirection), D(n.labelInside, e.get("axisLabel.inside")) && (a.labelDirection = -a.labelDirection);
		var m = e.get("axisLabel.rotate");
		return a.labelRotate = "top" === s ? -m : m, a.labelInterval = r.getLabelInterval(), a.z2 = 1, a
	}
	...
	function Lu(t, e, n) {
		cf.call(this), this.updateData(t, e, n)
	}
	...
	function Bu(t) {
		this.group = new cf, this._symbolCtor = t || Lu
	}
	...
	function Wu(t, e, n, i, r, a, o, s, l, h, u) {
		return null == h ? Xu(e, "x") ? ju(t, e, n, i, r, a, o, s, l, "x", u) : Xu(e, "y") ? ju(t, e, n, i, r, a, o, s, l, "y", u) : Uu.apply(this, arguments) : "none" !== h && Xu(e, h) ? ju.apply(this, arguments) : Uu.apply(this, arguments)
	}
	...
	function Xu(t, e) {
		...
		for(var n = "x" === e ? 0 : 1, i = t[0][n], r = 0, a = 1; a < t.length; ++a) {
			var o = t[a][n] - i;
			if(!isNaN(o) && !isNaN(r) && 0 !== o && 0 !== r && o >= 0 != r >= 0) return !1;
			isNaN(o) || 0 === o || (r = o, i = t[a][n])
		}
		return !0
	}

	function ju(t, e, n, i, r, a, o, s, l, h, u) {
		for(var c = 0, d = n, f = 0; i > f; f++) {
			...
			if(d === n) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]);
				...
				var g = e[c],
					v = "y" === h ? 1 : 0,
					m = (p[v] - g[v]) * l;
				h_(c_, g), c_[v] = g[v] + m, h_(d_, p), d_[v] = p[v] - m, t.bezierCurveTo(c_[0], c_[1], d_[0], d_[1], p[0], p[1])
	...
	function Uu(t, e, n, i, r, a, o, s, l, h, u) {
		for(var c = 0, d = n, f = 0; i > f; f++) {
			var p = e[d];
			if(d >= r || 0 > d) break;
			if(Vu(p)) {
			...
			if(d === n) t[a > 0 ? "moveTo" : "lineTo"](p[0], p[1]), h_(c_, p);
			else if(l > 0) {
				var g = d + a,
					v = e[g];
				if(u)
					for(; v && Vu(e[g]);) g += a, v = e[g];
				var m = .5,
					y = e[c],
					v = e[g];
				if(!v || Vu(v)) h_(d_, p);
					...
					} else x = Id(p, y), _ = Id(p, v);
					m = _ / (_ + x), l_(d_, p, u_, -l * (1 - m))
				}
				o_(c_, c_, s), s_(c_, c_, o), o_(d_, d_, s), s_(d_, d_, o), t.bezierCurveTo(c_[0], c_[1], d_[0], d_[1], p[0], p[1]), l_(c_, p, u_, l * m)
			} else t.lineTo(p[0], p[1]);
			c = d, d += a
		}
		return f
	...
	function Ku(t, e, n) {
		...
		for(var i = [], r = 0, a = e.count(); a > r; r++) i.push(Hu(n, t, e, r));
		return i
	}
	...
	function Qu(t, e, n) {
		...
		return e && (d.shape[a ? "width" : "height"] = 0, ba(d, {
			shape: {
				width: l,
				height: h
			}
	...
	function Ju(t, e, n) {
		...
		return e && (l.shape.endAngle = -o[0] * s, ba(l, {
			shape: {
				endAngle: -o[1] * s
			}
		}, n)), l
	...
	function tc(t, e, n) {
		return "polar" === t.type ? Ju(t, e, n) : Qu(t, e, n)
	}
	...
	function ic(t, e, n, i) {
		...
		i.dispatchAction({
			...
			rc(r.getItemGraphicEl(t), r.getItemLayout(t), e.isSelected(r.getName(t)), s, n)
		})
	}
	...
	function gc(t, e) {
		var n = e.axis,
			...
			o = Number.MAX_VALUE,
			s = -1;
		return W_(e.seriesModels, function(e) {
			...
			if(null != l && isFinite(l)) {
				var d = t - l,
					f = Math.abs(d);
				o >= f && ((o > f || d >= 0 && 0 > s) && (o = f, s = d, r = l, a.length = 0), W_(h, function(t) {
					a.push({
	...
	function xc(t, e, n, i) {
		if(Sc(e) || !t.list.length) return void i({
			type: "hideTip"
		});
	...
	function _c(t, e, n) {
		...
		W_(t, function(t) {
			...
			"show" === e.status && W_(e.seriesDataIndices, function(t) {
	...
	function Mc(t, e, n) {
		if(!sd.node) {
			var i = e.getZr();
			Y_(i).records || (Y_(i).records = {}), Ic(i, e);
			var r = Y_(i).records[t] || (Y_(i).records[t] = {});
			r.handler = n
		}
	}
	...
	function Ic(t, e) {
		function n(n, i) {
			t.on(n, function(n) {
				var r = kc(e);
				q_(Y_(t).records, function(t) {
					t && i(t, n, r.dispatchAction)
				}), Tc(r.pendings, e)
			})
		}
		Y_(t).initialized || (Y_(t).initialized = !0, n("click", x(Dc, "click")), n("mousemove", x(Dc, "mousemove")), n("globalout", Cc))
	}
	...
	function Lc(t, e, n, i) {
		Oc($_(n).lastProp, i) || ($_(n).lastProp = i, e ? wa(n, i, t) : (n.stopAnimation(), n.attr(i)))
	}
	...
	function Nc(t, e, n, i, r) {
		var a = n.get("value"),
			o = Hc(a, e.axis, e.ecModel, n.get("seriesDataIndices"), {
		...
		"bottom" === g && (c[1] -= f), "middle" === g && (c[1] -= f / 2), Fc(c, d, f, i);
	...
	function Vc(t, e, n, i, r, a) {
		var o = Fx.innerTextLayout(n.rotation, 0, n.labelDirection);
		n.labelMargin = r.get("label.margin"), Nc(e, i, r, a, {
			position: Gc(i.axis, t, n),
			align: o.textAlign,
	...
	function qc(t) {
		var e = [],
			n = t.get("fontSize"),
			i = t.getTextColor();
		return i && e.push("color:" + i), e.push("font:" + t.getFont()), n && e.push("line-height:" + Math.round(3 * n / 2) + "px"), ew(["decoration", "align"], function(n) {
			var i = t.get(n);
			i && e.push("text-" + n + ":" + i)
		}), e.join(";")
	}
	...
	function Zc(t) {
		var e = [],
			...
			a = t.get("padding");
		return n && e.push(Yc(n)), i && (sd.canvasSupported ? e.push("background-Color:" + i) : (e.push("background-Color:#" + Ne(i)), e.push("filter:alpha(opacity=70)"))), ew(["width", "color", "radius"], function(n) {
			var i = "border-" + n,
				r = nw(i),
				a = t.get(r);
			null != a && e.push(i + ":" + a + ("color" === n ? "" : "px"))
		}), e.push(qc(r)), null != a && e.push("padding:" + ov(a).join("px ") + "px"), e.join(";") + ";"
	}

	function $c(t, e) {
		if(sd.wxa) return null;
		var n = document.createElement("div"),
			i = this._zr = e.getZr();
	...
	var sd = od,
		...
		md = {},
		yd = function() {
			return md.createCanvas()
		};
	md.createCanvas = function() {
		return document.createElement("canvas")
	};
	var xd, _d = "__ec_primitive__";
	R.prototype = {
		constructor: R,
		get: function(t) {
	...
	var wd = (Object.freeze || Object)({
		...
		bd = "undefined" == typeof Float32Array ? Array : Float32Array,
		Sd = q,
		Md = Z,
		Id = ee,
		Td = ne,
	...
	var Pd = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
		Ld = function(t, e, n, i) {
			kd.call(this), this.storage = t, this.painter = e, this.painterRoot = i, n = n || new ce, this.proxy = null, this._hovered = {}, this._lastTouchMoment, this._lastX, this._lastY, le.call(this), this.setHandlerProxy(n)
		};
	Ld.prototype = {
		constructor: Ld,
		setHandlerProxy: function(t) {
			this.proxy && this.proxy.dispose(), t && (f(Pd, function(e) {
		...
		findHover: function(t, e, n) {
			for(var i = this.storage.getDisplayList(), r = {
				...
				var o;
				if(i[a] !== n && !i[a].ignore && (o = de(i[a], t, e)) && (!r.topTarget && (r.topTarget = i[a]), o !== Ad)) {
					r.target = i[a];
					break
				}
			}
		...
		Ld.prototype[t] = function(e) {
			...
			if("mousedown" === t) this._downEl = i, this._downPoint = [e.zrX, e.zrY], this._upEl = i;
				...
				if(this._downEl !== this._upEl || !this._downPoint || Id(this._downPoint, [e.zrX, e.zrY]) > 4) return;
				this._downPoint = null
			}
			this.dispatchToElement(n, t, e)
		}
	}), c(Ld, kd), c(Ld, le);
	var Od = "undefined" == typeof Float32Array ? Array : Float32Array,
		...
		Nd = Rd.prototype;
	Nd.transform = null, Nd.needLocalTransform = function() {
		return be(this.rotation) || be(this.position[0]) || be(this.position[1]) || be(this.scale[0] - 1) || be(this.scale[1] - 1)
	}, Nd.updateTransform = function() {
		var t = this.parent,
			e = t && t.transform,
			n = this.needLocalTransform(),
			i = this.transform;
		return n || e ? (i = i || fe(), n ? this.getLocalTransform(i) : Ed(i), e && (n ? ve(i, t.transform, i) : ge(i, t.transform)), this.transform = i, this.invTransform = this.invTransform || fe(), void _e(this.invTransform, i)) : void(i && Ed(i))
	}, Nd.getLocalTransform = function(t) {
		return Rd.getLocalTransform(this, t)
	}, Nd.setTransform = function(t) {
		var e = this.transform,
			n = t.dpr || 1;
		e ? t.setTransform(n * e[0], n * e[1], n * e[2], n * e[3], n * e[4], n * e[5]) : t.setTransform(n, 0, 0, n, 0, 0)
	}, Nd.restoreTransform = function(t) {
		var e = t.dpr || 1;
		t.setTransform(e, 0, 0, e, 0, 0)
	};
	var Fd = [];
	Nd.decomposeTransform = function() {
		if(this.transform) {
			var t = this.parent,
				e = this.transform;
			t && t.transform && (ve(Fd, t.invTransform, e), e = Fd);
	...
	}, Nd.getGlobalScale = function() {
		var t = this.transform;
		if(!t) return [1, 1];
		var e = Math.sqrt(t[0] * t[0] + t[1] * t[1]),
			n = Math.sqrt(t[2] * t[2] + t[3] * t[3]);
		return t[0] < 0 && (e = -e), t[3] < 0 && (n = -n), [e, n]
	}, Nd.transformCoordToLocal = function(t, e) {
		var n = [t, e],
			i = this.invTransform;
		return i && ae(n, n, i), n
	}, Nd.transformCoordToGlobal = function(t, e) {
		var n = [t, e],
			i = this.transform;
		return i && ae(n, n, i), n
	}, Rd.getLocalTransform = function(t, e) {
		e = e || [], Ed(e);
		var n = t.origin,
			i = t.scale || [1, 1],
			r = t.rotation || 0,
	...
	var Hd = {
		...
		bounceIn: function(t) {
			return 1 - Hd.bounceOut(1 - t)
		},
		bounceOut: function(t) {
			return 1 / 2.75 > t ? 7.5625 * t * t : 2 / 2.75 > t ? 7.5625 * (t -= 1.5 / 2.75) * t + .75 : 2.5 / 2.75 > t ? 7.5625 * (t -= 2.25 / 2.75) * t + .9375 : 7.5625 * (t -= 2.625 / 2.75) * t + .984375
		},
		bounceInOut: function(t) {
			return .5 > t ? .5 * Hd.bounceIn(2 * t) : .5 * Hd.bounceOut(2 * t - 1) + .5
		}
	};
	Se.prototype = {
		constructor: Se,
	...
	var Gd = function() {
		...
		Vd = Gd.prototype;
	Vd.insert = function(t) {
		var e = new Wd(t);
		return this.insertEntry(e), e
	}, Vd.insertEntry = function(t) {
		this.head ? (this.tail.next = t, t.prev = this.tail, t.next = null, this.tail = t) : this.head = this.tail = t, this._len++
	}, Vd.remove = function(t) {
		var e = t.prev,
			n = t.next;
	...
	var Wd = function(t) {
		...
		Xd = function(t) {
			this._list = new Gd, this._map = {}, this._maxSize = t || 10, this._lastRemovedEntry = null
		},
		jd = Xd.prototype;
	jd.put = function(t, e) {
		var n = this._list,
		...
		if(null == i[t]) {
			...
			o ? o.value = e : o = new Wd(e), o.key = t, n.insertEntry(o), i[t] = o
		}
		return r
	}, jd.get = function(t) {
		var e = this._map[t],
	...
	var tf = 1;
	"undefined" != typeof window && (tf = Math.max(window.devicePixelRatio || 1, 1));
	var ef = 0,
		nf = tf,
		rf = function() {};
	1 === ef ? rf = function() {
	...
	var af = rf,
		...
		animate: function(t, e) {
			...
			if(!n) return void af('Property "' + t + '" is not existed in element ' + r.id);
			var c = r.animators,
				d = new Jd(n, e);
	...
	var sf = function(t) {
		Rd.call(this, t), kd.call(this, t), of .call(this, t), this.id = t.id || ad()
	};
	sf.prototype = {
		type: "element",
		name: "",
	...
	rn.prototype = {
		...
		union: function(t) {
			var e = hf(t.x, this.x),
				n = hf(t.y, this.y);
			this.width = uf(t.x + t.width, this.x + this.width) - e, this.height = uf(t.y + t.height, this.y + this.height) - n, this.x = e, this.y = n
		},
		applyTransform: function() {
			...
			return function(r) {
				if(r) {
					t[0] = n[0] = this.x, t[1] = i[1] = this.y, e[0] = i[0] = this.x + this.width, e[1] = n[1] = this.y + this.height, lf(t, t, r), lf(e, e, r), lf(n, n, r), lf(i, i, r), this.x = hf(t[0], e[0], n[0], i[0]), this.y = hf(t[1], e[1], n[1], i[1]);
					var a = uf(t[0], e[0], n[0], i[0]),
						o = uf(t[1], e[1], n[1], i[1]);
	...
	cf.prototype = {
		...
		_doAdd: function(t) {
			...
			var e = this.__storage,
				n = this.__zr;
			e && e !== t.__storage && (e.addToStorage(t), t instanceof cf && t.addChildrenToStorage(e)), n && n.refresh()
		},
		remove: function(t) {
			var e = this.__zr,
				n = this.__storage,
				i = this._children,
				r = h(i, t);
			return 0 > r ? this : (i.splice(r, 1), t.parent = null, n && (n.delFromStorage(t), t instanceof cf && t.delChildrenFromStorage(n)), e && e.refresh(), this)
		},
		removeAll: function() {
			var t, e, n = this._children,
				i = this.__storage;
			for(e = 0; e < n.length; e++) t = n[e], i && (i.delFromStorage(t), t instanceof cf && t.delChildrenFromStorage(i)), t.parent = null;
		...
		addChildrenToStorage: function(t) {
			for(var e = 0; e < this._children.length; e++) {
				...
				t.addToStorage(n), n instanceof cf && n.addChildrenToStorage(t)
			}
		},
		delChildrenFromStorage: function(t) {
			for(var e = 0; e < this._children.length; e++) {
				var n = this._children[e];
				t.delFromStorage(n), n instanceof cf && n.delChildrenFromStorage(t)
			}
		},
		dirty: function() {
	...
	pf.prototype = {
		...
		updateDisplayList: function(t) {
			...
			n.length = this._displayListLen, sd.canvasSupported && dn(n, fn)
		},
		...
		addRoot: function(t) {
			t.__storage !== this && (t instanceof cf && t.addChildrenToStorage(this), this.addToStorage(t), this._roots.push(t))
		},
		delRoot: function(t) {
			if(null == t) {
				for(var e = 0; e < this._roots.length; e++) {
					var n = this._roots[e];
					n instanceof cf && n.delChildrenFromStorage(this)
				}
			...
			if(t instanceof Array)
				...
				r >= 0 && (this.delFromStorage(t), this._roots.splice(r, 1), t instanceof cf && t.delChildrenFromStorage(this))
			}
		},
	...
	yf.prototype = {
		...
		blend: null,
		bind: function(t, e, n) {
			for(var i = this, r = n && n.style, a = !r, o = 0; o < mf.length; o++) {
				var s = mf[o],
					l = s[0];
				(a || i[l] !== r[l]) && (t[l] = vf(t, l, i[l] || s[1]))
			}
	...
	for(var xf = yf.prototype, _f = 0; _f < mf.length; _f++) {
		var wf = mf[_f];
		wf[0] in xf || (xf[wf[0]] = wf[1])
	}
	yf.getGradient = xf.getGradient;
	var bf = function(t, e) {
		this.image = t, this.repeat = e, this.type = "pattern"
	};
	bf.prototype.getCanvasPattern = function(t) {
		return t.createPattern(this.image, this.repeat || "repeat")
	};
	var Sf = function(t, e, n) {
		var i;
		n = n || nf, "string" == typeof t ? i = mn(t, e, n) : S(t) && (i = t, t = i.id), this.id = t, this.dom = i;
		var r = i.style;
	...
	Sf.prototype = {
		...
		clear: function(t, e) {
			...
			if(o && (this.domBack || this.createBackBuffer(), this.ctxBack.globalCompositeOperation = "copy", this.ctxBack.drawImage(n, 0, 0, r / l, a / l)), i.clearRect(0, 0, r, a), e && "transparent" !== e) {
				var h;
				e.colorStops ? (h = e.__canvasGradient || yf.getGradient(i, e, {
					x: 0,
					y: 0,
					width: r,
					height: a
				}), e.__canvasGradient = h) : e.image && (h = bf.prototype.getCanvasPattern.call(e, i)), i.save(), i.fillStyle = h || e, i.fillRect(0, 0, r, a), i.restore()
			}
			if(o) {
				var u = this.domBack;
	...
	var Mf = "undefined" != typeof window && (window.requestAnimationFrame && window.requestAnimationFrame.bind(window) || window.msRequestAnimationFrame && window.msRequestAnimationFrame.bind(window) || window.mozRequestAnimationFrame || window.webkitRequestAnimationFrame) || function(t) {
		...
		Af = "12px sans-serif",
		Pf = {};
	Pf.measureText = function(t, e) {
		var n = l();
		return n.font = e || Af, n.measureText(t)
	};
	var Lf = {
			left: 1,
			right: 1,
	...
	Ef.prototype = {
		...
		drawRectText: function(t, e) {
			...
			if(null != i && (i += ""), ii(i, n)) {
				...
				n.transformText ? this.setTransform(t) : r && (Bf.copy(e), Bf.applyTransform(r), e = Bf), Vn(this, t, i, n, e), t.restore()
			}
		}
	}, ri.prototype = {
		constructor: ri,
		...
		attrKV: function(t, e) {
			"style" !== t ? sf.prototype.attrKV.call(this, t, e) : this.style.set(e)
		},
		setStyle: function(t, e) {
			return this.style.set(t, e), this.dirty(!1), this
		},
		useStyle: function(t) {
			return this.style = new yf(t, this), this.dirty(!1), this
		}
	}, u(ri, sf), c(ri, Ef), ai.prototype = {
		constructor: ai,
		type: "image",
		brush: function(t, e) {
			var n = this.style,
	...
	var zf = 1e5,
		...
		Vf = function(t, e, n) {
			...
			this._opts = n = o({}, n || {}), this.dpr = n.devicePixelRatio || nf, this._singleCanvas = i, this.root = t;
			var r = t.style;
			...
			if(this._layerConfig = {}, this._needsManuallyCompositing = !1, i) {
				...
				var u = new Sf(t, this, this.dpr);
				u.__builtin__ = !0, u.initContext(), s[Rf] = u, a.push(Rf), this._domRoot = t
			} else {
	...
	Vf.prototype = {
		...
		refreshHover: function() {
			var t = this._hoverElements,
				...
				n = this._hoverlayer;
			if(n && n.clear(), e) {
				dn(t, this.storage.displayableSortFunc), n || (n = this._hoverlayer = this.getLayer(zf));
				var i = {};
				n.ctx.save();
				for(var r = 0; e > r;) {
					var a = t[r],
		...
		_doPaintList: function(t, e) {
			...
			return sd.wxa && f(this._layers, function(t) {
		...
		getLayer: function(t, e) {
			this._singleCanvas && !this._needsManuallyCompositing && (t = Rf);
			var n = this._layers[t];
			return n || (n = new Sf("zr_" + t, this, this.dpr), n.zlevel = t, n.__builtin__ = !0, this._layerConfig[t] && r(n, this._layerConfig[t], !0), e && (n.virtual = e), this.insertLayer(t, n), n.initContext()), n
		},
		insertLayer: function(t, e) {
			var n = this._layers,
				...
				o = -1,
				s = this._domRoot;
			if(n[t]) return void af("ZLevel " + t + " has been used already");
			if(!si(e)) return void af("Layer of zlevel " + t + " is not valid");
			if(r > 0 && t > i[0]) {
		...
		_updateLayerStatus: function(t) {
			...
			for(var r = null, a = 0, n = 0; n < t.length; n++) {
				var o, i = t[n],
					s = i.zlevel;
				i.incremental ? (o = this.getLayer(s + Ff, this._needsManuallyCompositing), o.incremental = !0, a = 1) : o = this.getLayer(s + (a > 0 ? Nf : 0), this._needsManuallyCompositing), o.__builtin__ || af("ZLevel " + s + " has been used by unkown layer " + o.id), o !== r && (o.__used = !0, o.__startIndex !== n && (o.__dirty = !0), o.__startIndex = n, o.__drawIndex = o.incremental ? -1 : n, e(n), r = o), i.__dirty && (o.__dirty = !0, o.incremental && o.__drawIndex < 0 && (o.__drawIndex = n))
			}
		...
		resize: function(t, e) {
			if(this._domRoot.style) {
				...
				this._width = t, this._height = e, this.getLayer(Rf).resize(t, e)
			}
			return this
		},
		...
		getRenderedCanvas: function(t) {
			if(t = t || {}, this._singleCanvas && !this._compositeManually) return this._layers[Rf].dom;
			var e = new Sf("image", this, t.pixelRatio || this.dpr);
	...
	var Wf = "undefined" != typeof window && !!window.addEventListener,
		...
		Uf = function(t) {
			t = t || {}, this.stage = t.stage || {}, this.onframe = t.onframe || function() {}, this._clips = [], this._running = !1, this._time, this._pausedTime, this._pauseStart, this._paused = !1, kd.call(this)
		};
	Uf.prototype = {
		constructor: Uf,
		addClip: function(t) {
		...
		animate: function(t, e) {
			e = e || {};
			var n = new Jd(t, e.loop, e.getter, e.setter);
	...
	var qf = {
		...
		Zf = 300,
		$f = ["click", "dblclick", "mousewheel", "mouseout", "mouseup", "mousedown", "mousemove", "contextmenu"],
		Kf = ["touchstart", "touchend", "touchmove"],
		Qf = {
			pointerdown: 1,
			pointerup: 1,
			pointermove: 1,
		...
		tp = {
			...
			touchend: function(t) {
				t = gi(this.dom, t), t.zrByTouch = !0, wi(this, t, "end"), tp.mouseup.call(this, t), +new Date - this._lastTouchMoment < Zf && tp.click.call(this, t), bi(this)
			},
	...
	var ep = Ii.prototype;
	ep.dispose = function() {
		for(var t = $f.concat(Kf), e = 0; e < t.length; e++) {
			var n = t[e];
	...
	var np = !sd.canvasSupported,
		...
		op = function(t, e, n) {
			...
			var o = new ip[a](e, r, n, t);
			this.storage = r, this.painter = o;
			var s = sd.node || sd.worker ? null : new Ii(o.getViewportRoot());
			this.handler = new Ld(r, o, s, o.root), this.animation = new Uf({
				stage: {
	...
	Jp.prototype = {
		...
		setScale: function(t, e) {
			this._ux = Kp(1 / nf / t) || 0, this._uy = Kp(1 / nf / e) || 0
		},
		getContext: function() {
			return this._ctx
		},
		...
		lineTo: function(t, e) {
			var n = Kp(t - this._xi) > this._ux || Kp(e - this._yi) > this._uy || this._len < 5;
		...
		arc: function(t, e, n, i, r, a) {
			return this.addData(Gp.A, t, e, n, n, i, r - i, 0, a ? 0 : 1), this._ctx && this._ctx.arc(t, e, n, i, r, a), this._xi = qp(r) * n + t, this._yi = Zp(r) * n + t, this
		},
		...
		appendPath: function(t) {
			...
			Qp && this.data instanceof Float32Array && (this.data = new Float32Array(i + n));
			for(var r = 0; e > r; r++)
		...
		_dashedLineTo: function(t, e) {
			var n, i, r = this._dashSum,
				...
				p = h,
				g = o.length;
			for(u /= d, c /= d, 0 > a && (a = r + a), a %= r, f -= a * u, p -= a * c; u > 0 && t >= f || 0 > u && f >= t || 0 == u && (c > 0 && e >= p || 0 > c && p >= e);) i = this._dashIdx, n = o[i], f += u * n, p += c * n, this._dashIdx = (i + 1) % g, u > 0 && l > f || 0 > u && f > l || c > 0 && h > p || 0 > c && p > h || s[i % 2 ? "moveTo" : "lineTo"](u >= 0 ? Up(f, t) : Yp(f, t), c >= 0 ? Up(p, e) : Yp(p, e));
			u = f - t, c = p - e, this._dashOffset = -$p(u * u + c * c)
		},
		_dashedBezierTo: function(t, e, n, i, r, a) {
			var o, s, l, h, u, c = this._dashSum,
				...
				_ = f.length,
				w = 0;
			for(0 > d && (d = c + d), d %= c, o = 0; 1 > o; o += .1) s = m(g, t, n, r, o + .1) - m(g, t, n, r, o), l = m(v, e, i, a, o + .1) - m(v, e, i, a, o), y += $p(s * s + l * l);
			for(; _ > x && (w += f[x], !(w > d)); x++);
			for(o = (w - d) / y; 1 >= o;) h = m(g, t, n, r, o), u = m(v, e, i, a, o), x % 2 ? p.moveTo(h, u) : p.lineTo(h, u), o += f[x] / y, x = (x + 1) % _;
			x % 2 !== 0 && p.lineTo(r, a), s = r - h, l = a - u, this._dashOffset = -$p(s * s + l * l)
		},
		...
		getBoundingRect: function() {
			Vp[0] = Vp[1] = Xp[0] = Xp[1] = Number.MAX_VALUE, Wp[0] = Wp[1] = jp[0] = jp[1] = -Number.MAX_VALUE;
			for(var t = this.data, e = 0, n = 0, i = 0, r = 0, a = 0; a < t.length;) {
				var o = t[a++];
				switch(1 == a && (e = t[a], n = t[a + 1], i = e, r = n), o) {
					case Gp.M:
						i = t[a++], r = t[a++], e = i, n = r, Xp[0] = i, Xp[1] = r, jp[0] = i, jp[1] = r;
						break;
					case Gp.L:
						fr(e, n, t[a], t[a + 1], Xp, jp), e = t[a++], n = t[a++];
						break;
					case Gp.C:
						pr(e, n, t[a++], t[a++], t[a++], t[a++], t[a], t[a + 1], Xp, jp), e = t[a++], n = t[a++];
						break;
					case Gp.Q:
						gr(e, n, t[a++], t[a++], t[a], t[a + 1], Xp, jp), e = t[a++], n = t[a++];
						break;
					case Gp.A:
						var s = t[a++],
							l = t[a++],
							...
							d = t[a++] + c,
							f = (t[a++], 1 - t[a++]);
						1 == a && (i = qp(c) * h + s, r = Zp(c) * u + l), vr(s, l, h, u, c, d, f, Xp, jp), e = qp(d) * h + s, n = Zp(d) * u + l;
						break;
					case Gp.R:
						i = e = t[a++], r = n = t[a++];
						var p = t[a++],
							g = t[a++];
						fr(i, r, i + p, r + g, Xp, jp);
						break;
					case Gp.Z:
						e = i, n = r
				}
				oe(Vp, Vp, Xp), se(Wp, Wp, jp)
			}
			return 0 === a && (Vp[0] = Vp[1] = Wp[0] = Wp[1] = 0), new rn(Vp[0], Vp[1], Wp[0] - Vp[0], Wp[1] - Vp[1])
		},
			...
			for(var e, n, i, r, a, o, s = this.data, l = this._ux, h = this._uy, u = this._len, c = 0; u > c;) {
				...
				switch(1 == c && (i = s[c], r = s[c + 1], e = i, n = r), d) {
					case Gp.M:
						...
						break;
					case Gp.L:
						a = s[c++], o = s[c++], (Kp(a - i) > l || Kp(o - r) > h || c === u - 1) && (t.lineTo(a, o), i = a, r = o);
						break;
					case Gp.C:
					...
					case Gp.A:
						var f = s[c++],
							...
							M = Math.abs(g - v) > .001,
							I = m + y;
						M ? (t.translate(f, p), t.rotate(x), t.scale(b, S), t.arc(0, 0, w, m, I, 1 - _), t.scale(1 / b, 1 / S), t.rotate(-x), t.translate(-f, -p)) : t.arc(f, p, w, m, I, 1 - _), 1 == c && (e = qp(m) * g + f, n = Zp(m) * v + p), i = qp(I) * g + f, r = Zp(I) * v + p;
						break;
					case Gp.R:
	...
	var tg = 2 * Math.PI,
		...
		ag = [-1, -1, -1],
		og = [-1, -1],
		sg = bf.prototype.getCanvasPattern,
		lg = Math.abs,
		hg = new Jp(!0);
	Pr.prototype = {
		constructor: Pr,
		...
		getBoundingRect: function() {
			...
			if(n) {
				var i = this.path;
				i || (i = this.path = new Jp), this.__dirtyPath && (i.beginPath(), this.buildPath(i, this.shape, !1)), t = i.getBoundingRect()
			}
	...
	var ug = Jp.CMD,
		...
		wg = function(t, e) {
			return(t[0] * e[0] + t[1] * e[1]) / (_g(t) * _g(e))
		},
		bg = function(t, e) {
	...
	Sg.prototype = {
		...
		brush: function(t, e) {
			...
			var i = n.text;
			null != i && (i += ""), n.bind(t, this, e), ii(i, n) && (this.setTransform(t), Vn(this, t, i, n), this.restoreTransform(t))
		},
		getBoundingRect: function() {
			var t = this.style;
	...
	var Mg = Pr.extend({
		...
		Tg = function(t) {
			return sd.browser.ie && sd.browser.version >= 11 ? function() {
				...
				if(t.apply(this, arguments), e)
					for(var l = 0; l < Ig.length; l++) i[Ig[l][0]] = Ig[l][2]
			} : t
		},
		Cg = Pr.extend({
			type: "sector",
		...
		zg = Pr.extend({
			...
			buildPath: function(t, e) {
				var n = e.x1,
					...
					h = e.cpy2,
					u = e.percent;
				0 !== u && (t.moveTo(n, i), null == l || null == h ? (1 > u && (ur(n, o, r, u, Eg), o = Eg[1], r = Eg[2], ur(i, s, a, u, Eg), s = Eg[1], a = Eg[2]), t.quadraticCurveTo(o, s, r, a)) : (1 > u && (rr(n, o, l, r, u, Eg), o = Eg[1], l = Eg[2], r = Eg[3], rr(i, s, h, a, u, Eg), s = Eg[1], h = Eg[2], a = Eg[3]), t.bezierCurveTo(o, s, l, h, r, a)))
			},
			pointAt: function(t) {
	...
	var Hg = function(t, e, n, i, r, a) {
		this.x = null == t ? 0 : t, this.y = null == e ? 0 : e, this.x2 = null == n ? 1 : n, this.y2 = null == i ? 0 : i, this.type = "linear", this.global = a || !1, Fg.call(this, r)
	};
	Hg.prototype = {
		constructor: Hg
	}, u(Hg, Fg);
	var Gg = function(t, e, n, i, r) {
		this.x = null == t ? .5 : t, this.y = null == e ? .5 : e, this.r = null == n ? .5 : n, this.type = "radial", this.global = r || !1, Fg.call(this, i)
	};
	Gg.prototype = {
		constructor: Gg
	}, u(Gg, Fg), Gr.prototype.incremental = !0, Gr.prototype.clearDisplaybles = function() {
	...
	var Vg = [];
	Gr.prototype.getBoundingRect = function() {
		if(!this._rect) {
			for(var t = new rn(1 / 0, 1 / 0, -1 / 0, -1 / 0), e = 0; e < this._displayables.length; e++) {
				var n = this._displayables[e],
					i = n.getBoundingRect().clone();
				n.needLocalTransform() && i.applyTransform(n.getLocalTransform(Vg)), t.union(i)
			}
			this._rect = t
		}
		return this._rect
	...
	var Wg = Math.round,
		...
		$g = {
			getTextColor: function(t) {
				var e = this.ecModel;
				return this.getShallow("color") || (!t && e ? e.get(Zg) : null)
			},
			getFont: function() {
				return xa({
	...
	}, Yi(Aa), qi(Aa), Jg(Aa, xp), Jg(Aa, wp), Jg(Aa, $g), Jg(Aa, Qg);
	var ev = 0,
		nv = 1e-4,
		iv = 9007199254740991,
		rv = /^(?:(\d{4})(?:[-\/](\d{1,2})(?:[-\/](\d{1,2})(?:[T ](\d{1,2})(?::(\d\d)(?::(\d\d)(?:[.,](\d+))?)?)?(Z|[\+\-]\d\d:?\d\d)?)?)?)?)?$/,
		...
		dv = f,
		fv = ["left", "right", "top", "bottom", "width", "height"],
		pv = [
			["width", "left", "right"],
			["height", "top", "bottom"]
		],
		gv = lo,
		vv = (x(lo, "vertical"), x(lo, "horizontal"), {
	...
	}), Ba(yv), Ea(yv, po), c(yv, vv);
	var xv = "";
	"undefined" != typeof navigator && (xv = navigator.platform || "");
	var _v = {
			color: ["#c23531", "#2f4554", "#61a0a8", "#d48265", "#91c7ae", "#749f83", "#ca8622", "#bda29a", "#6e7074", "#546570", "#c4ccd3"],
			gradientColor: ["#f6efa6", "#d88273", "#bf444c"],
			textStyle: {
				fontFamily: xv.match(/^Win/) ? "Microsoft YaHei" : "sans-serif",
				fontSize: 12,
				fontStyle: "normal",
				fontWeight: "normal"
			},
		...
		bv = {
			clearColorPalette: function() {
				wv(this).colorIdx = 0, wv(this).colorNameMap = {}
			},
	...
	var Lv = Hi(),
		...
		Bv = Aa.extend({
			...
			setOption: function(t, e) {
				O(!(Ov in t), "please use chart.getOption()"), this._optionManager.setOption(t, e), this.resetOption(null)
			},
			resetOption: function(t) {
				...
				if(!t || "recreate" === t) {
					...
					this.option && "recreate" !== t ? (this.restoreData(), this.mergeOption(i)) : Lo.call(this, i), e = !0
				}
				...
				function e(e, i) {
					...
					n[e] = [], a.set(e, []), f(s, function(t, i) {
						...
						if(O(S(s) || r, "Empty component definition"), s) {
							var h = yv.getClass(e, t.keyInfo.subType, !0);
					...
					}, this), "series" === e && Eo(this, a.get("series"))
				}
				var n = this.option,
					a = this._componentsMap,
					s = [];
				_o(this), f(t, function(t, e) {
					null != t && (yv.hasClass(e) ? e && s.push(e) : n[e] = null == n[e] ? i(t) : r(n[e], t, !0))
				}), yv.topologicalTravel(s, yv.getAllClassMainTypes(), e, this), this._seriesIndicesMap = N(this._seriesIndices = this._seriesIndices || [])
			},
			getOption: function() {
				var t = i(this.option);
			...
			restoreData: function(t) {
				...
				Eo(this, e.get("series"));
				var n = [];
				e.each(function(t, e) {
					n.push(e)
				}), yv.topologicalTravel(n, yv.getAllClassMainTypes(), function(n) {
					f(e.get(n), function(e) {
						("series" !== n || !Ao(e, t)) && e.restoreData()
					})
				})
			}
		});
	c(Bv, bv);
	var Ev = ["getDom", "getZr", "getWidth", "getHeight", "getDevicePixelRatio", "dispatchAction", "isDisposed", "on", "off", "getDataURL", "getConnectedDataURL", "getModel", "getOption", "getViewOfComponentModel", "getViewOfSeriesModel"],
		zv = {};
	No.prototype = {
		constructor: No,
		create: function(t, e) {
	...
	Fo.prototype = {
		...
		mountOption: function(t) {
			...
			return this._timelineOptions = Fv(e.timelineOptions, Nv), this._mediaList = Fv(e.mediaList, Nv), this._mediaDefault = Nv(e.mediaDefault), this._currentMediaIndices = [], Nv(t ? e.baseOption : this._newBaseOption)
		},
		getTimelineOption: function(t) {
			var e, n = this._timelineOptions;
			if(n.length) {
				var i = t.getComponent("timeline");
				i && (e = Nv(n[i.getCurrentIndex()], !0))
			}
			return e
		},
		getMediaOption: function() {
			...
			return !r.length && i && (r = [-1]), r.length && !Wo(r, this._currentMediaIndices) && (a = Fv(r, function(t) {
				return Nv(-1 === t ? i.option : n[t].option)
			})), this._currentMediaIndices = r, a
		}
	};
	var Vv = f,
		Wv = S,
		Xv = ["areaStyle", "lineStyle", "nodeStyle", "linkStyle", "chordStyle", "label", "labelLine"],
		jv = function(t, e) {
			Vv(Ko(t.series), function(t) {
				Wv(t) && $o(t)
			});
			var n = ["xAxis", "yAxis", "radiusAxis", "angleAxis", "singleAxis", "parallelAxis", "radar"];
			e && n.push("valueAxis", "categoryAxis", "logAxis", "timeAxis"), Vv(n, function(e) {
				Vv(Ko(t[e]), function(t) {
					t && (qo(t, "axisLabel"), qo(t.axisPointer, "label"))
				})
			}), Vv(Ko(t.parallel), function(t) {
				var e = t && t.parallelAxisDefault;
				qo(e, "axisLabel"), qo(e && e.axisPointer, "label")
			}), Vv(Ko(t.calendar), function(t) {
				Uo(t, "itemStyle"), qo(t, "dayLabel"), qo(t, "monthLabel"), qo(t, "yearLabel")
			}), Vv(Ko(t.radar), function(t) {
				qo(t, "name")
			}), Vv(Ko(t.geo), function(t) {
				Wv(t) && (Zo(t), Vv(Ko(t.regions), function(t) {
					Zo(t)
				}))
			}), Vv(Ko(t.timeline), function(t) {
				Zo(t), Uo(t, "label"), Uo(t, "itemStyle"), Uo(t, "controlStyle", !0);
				var e = t.data;
				_(e) && f(e, function(t) {
					S(t) && (Uo(t, "label"), Uo(t, "itemStyle"))
				})
			}), Vv(Ko(t.toolbox), function(t) {
				Uo(t, "iconStyle"), Vv(t.feature, function(t) {
					Uo(t, "iconStyle")
				})
			}), qo(Qo(t.axisPointer), "label"), qo(Qo(t.tooltip).axisPointer, "label")
		},
		Uv = [
			["x", "left"],
			["y", "top"],
		...
		qv = function(t, e) {
			jv(t, e), t.series = Pi(t.series), f(t.series, function(t) {
				if(S(t)) {
					var e = t.type;
					if(("pie" === e || "gauge" === e) && null != t.clockWise && (t.clockwise = t.clockWise), "gauge" === e) {
						var n = Jo(t, "pointer.color");
						null != n && ts(t, "itemStyle.normal.color", n)
					}
					es(t)
				}
		...
		$v = is.prototype;
	$v.pure = !1, $v.persistent = !0, $v.getSource = function() {
		return this._source
	};
	var Kv = {
			arrayRows_column: {
			...
			typedArray: {
				...
				getItem: function(t) {
					t -= this._offset;
					for(var e = [], n = this._dimSize * t, i = 0; i < this._dimSize; i++) e[i] = this._data[n + i];
					return e
				},
				appendData: function(t) {
					this._data = t
		...
		Jv = {
			...
			objectRows: function(t, e) {
				return hs(t[e], this._dimensionInfos[e])
			},
			keyedColumns: ls,
			original: function(t, e, n, i) {
				var r = t && (null == t.value ? t : t.value);
				return !this._rawData.pure && Bi(t) && (this.hasItemOption = !0), hs(r instanceof Array ? r[i] : r, this._dimensionInfos[e])
			},
		...
		em = {
			...
			getFormattedLabel: function(t, e, n, i, r) {
				...
				if("string" == typeof l) {
					var h = no(l, s);
					return h.replace(tm, function(e, n) {
						var i = n.length;
						return "[" === n.charAt(0) && "]" === n.charAt(i - 1) && (n = +n.slice(1, i - 1)), us(a, t, n)
					})
				}
			},
			getRawValue: function(t, e) {
				return us(this.getData(e), t)
			},
			formatTooltip: function() {}
		},
		nm = fs.prototype;
	nm.perform = function(t) {
		...
		var a;
		(this._dirty || "reset" === r) && (this._dirty = !1, a = ps(this, n));
		var o = t && t.step;
	...
	var im = Hi(),
		rm = yv.extend({
			...
			layoutMode: null,
			init: function(t, e, n) {
				this.seriesIndex = this.componentIndex, this.dataTask = ds({
					count: ms,
					reset: ys
				}), this.dataTask.context = {
					model: this
				}, this.mergeDefaultAndTheme(t, n), wo(this);
				var i = this.getInitialData(t, n);
				_s(i, this), this.dataTask.context.data = i, im(this).dataBeforeProcessed = i, gs(this)
			},
			mergeDefaultAndTheme: function(t, e) {
				var n = this.layoutMode,
					i = n ? co(t) : {},
					a = this.subType;
				yv.hasClass(a) && (a += "Series"), r(t, e.getTheme().get(this.subType)), r(t, this.getDefaultOption()), Li(t, "label", ["show"]), this.fillDataTextStyle(t.data), n && uo(t, i, n)
			},
			mergeOption: function(t, e) {
				t = r(this.option, t, !0), this.fillDataTextStyle(t.data);
				var n = this.layoutMode;
				n && uo(this.option, t, n), wo(this);
				var i = this.getInitialData(t, e);
				_s(i, this), this.dataTask.dirty(), this.dataTask.context.data = i, im(this).dataBeforeProcessed = i, gs(this)
			},
			...
			setData: function(t) {
				...
				if(e) {
					var n = e.context;
					n.data !== t && e.isOverallFilter && e.setOutputEnd(t.count()), n.outputData = t, e !== this.dataTask && (n.data = t)
				}
				im(this).data = t
			},
			getSource: function() {
			...
			formatTooltip: function(t, e) {
				...
				var u = o > 1 || l && !o ? n(s) : i(o ? us(r, t, a[0]) : l ? s[0] : s),
					c = ro(h),
					d = r.getName(t),
					p = this.name;
			...
			getColorFromPalette: function(t, e, n) {
				var i = this.ecModel,
					r = bv.getColorFromPalette.call(this, t, e, n);
	...
	c(rm, em), c(rm, bv);
	var am = function() {
		this.group = new cf, this.uid = Oa("viewComponent")
	};
	am.prototype = {
		constructor: am,
		init: function() {},
	...
	var om = am.prototype;
	om.updateView = om.updateLayout = om.updateVisual = function() {}, Yi(am), Ki(am, {
		registerWhenExtend: !0
	});
	var sm = function() {
			var t = Hi();
	...
	Ss.prototype = {
		...
		highlight: function(t, e, n, i) {
			Is(t.getData(), i, "emphasis")
		},
		downplay: function(t, e, n, i) {
			Is(t.getData(), i, "normal")
		},
		remove: function() {
	...
	var um = Ss.prototype;
	um.updateView = um.updateLayout = um.updateVisual = function(t, e, n, i) {
		this.render(t, e, n, i)
	}, Yi(Ss, ["dispose"]), Ki(Ss, {
		registerWhenExtend: !0
	...
	var cm = {
		...
		dm = "\x00__throttleOriginMethod",
		fm = "\x00__throttleRate",
		pm = "\x00__throttleType",
		gm = {
			createOnAllSeries: !0,
			performRawSeries: !0,
			reset: function(t, e) {
				...
				if(n.setVisual("color", r), !e.isSeriesFiltered(t)) {
					"function" != typeof r || r instanceof Fg || n.each(function(e) {
		...
		mm = function(t, e) {
			...
			function i(t) {
				var e = o.get(t);
				if(null == e) {
					for(var n = t.split("."), i = vm.aria, r = 0; r < n.length; ++r) i = i[n[r]];
					return i
				}
				return e
			}
			...
			function a(t) {
				return vm.series.typeNames[t] || "自定义图"
			}
	...
	_m.getPerformArgs = function(t, e) {
		if(t.__pipeline) {
			var n = this._pipelineMap.get(t.__pipeline.id),
				i = n.context,
				r = !e && n.progressiveEnabled && (!i || i.canProgressiveRender) && t.__idxInPipeline > n.bockIndex;
			return {
				step: r ? n.step : null
			}
		}
		...
		f([this._dataProcessorHandlers, this._visualHandlers], function(i) {
			f(i, function(i) {
				...
				i.reset && Ls(this, i, r, e, n), i.overallReset && Os(this, i, r, e, n)
			}, this)
		}, this)
	}, _m.prepareView = function(t, e, n, i) {
		var r = t.renderTask,
			a = r.context;
		a.model = e, a.ecModel = n, a.api = i, r.__block = !t.incrementalPrepareRender, Vs(this, e, r)
	}, _m.performDataProcessorTasks = function(t, e) {
		Ps(this, this._dataProcessorHandlers, t, e, {
			block: !0
		})
	}, _m.performVisualTasks = function(t, e, n) {
	...
	var wm = _m.updatePayload = function(t, e) {
		"remain" !== e && (t.context.payload = e)
	};
	As.wrapStageHandler = function(t, e) {
		return w(t) && (t = {
			overallReset: t,
			seriesType: Ws(t)
	...
	var bm, Sm = {},
		Mm = {};
	Xs(Sm, Bv), Xs(Mm, Ro), Sm.eachSeriesByType = Sm.eachRawSeriesByType = function(t) {
		bm = t
	}, Sm.eachComponent = function(t) {
	...
	var Im = ["#37A2DA", "#32C5E9", "#67E0E3", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#E062AE", "#E690D1", "#e7bcf3", "#9d96f5", "#8378EA", "#96BFFF"],
		Tm = {
			...
			colorLayer: [
				...
				["#37A2DA", "#32C5E9", "#9FE6B8", "#FFDB5C", "#ff9f7f", "#fb7293", "#e7bcf3", "#8378EA", "#96BFFF"], Im
			]
		},
		Cm = "#eee",
		Dm = function() {
	...
	Am.categoryAxis.splitLine.show = !1;
	var Pm = O,
		Lm = f,
		Om = w,
		Bm = S,
		Em = yv.parseClassType,
		zm = "4.0.4",
		Rm = {
			zrender: "4.0.3"
		},
		...
		Ym = "__flagInMainProcess",
		qm = "__optionUpdated",
		Zm = /^[a-zA-Z0-9_]+$/;
	Us.prototype.on = js("on"), Us.prototype.off = js("off"), Us.prototype.one = js("one"), c(Us, kd);
	var $m = Ys.prototype;
	$m._onframe = function() {
		if(!this._disposed) {
			var t = this._scheduler;
			if(this[qm]) {
				var e = this[qm].silent;
				this[Ym] = !0, Zs(this), Km.update.call(this), this[Ym] = !1, this[qm] = !1, Js.call(this, e), tl.call(this, e)
				...
				do {
					var a = +new Date;
					t.performSeriesTasks(i), t.performDataProcessorTasks(i), Ks(this, i), t.performVisualTasks(i), ol(this, this._model, r, "remain"), n -= +new Date - a
		...
		return this._zr
	}, $m.setOption = function(t, e, n) {
		var i;
		if(Bm(e) && (n = e.lazyUpdate, i = e.silent, e = e.notMerge), this[Ym] = !0, !this._model || e) {
			var r = new Fo(this._api),
				a = this._theme,
				o = this._model = new Bv(null, null, a, r);
			o.scheduler = this._scheduler, o.init(null, null, a, r)
		}
		this._model.setOption(t, ny), n ? (this[qm] = {
			silent: i
		}, this[Ym] = !1) : (Zs(this), Km.update.call(this), this._zr.flush(), this[qm] = !1, this[Ym] = !1, Js.call(this, i), tl.call(this, i))
	}, $m.setTheme = function() {
		console.log("ECharts#setTheme() is DEPRECATED in ECharts 3.0")
	}, $m.getModel = function() {
		return this._model
	}, $m.getOption = function() {
		return this._model && this._model.getOption()
	}, $m.getWidth = function() {
		return this._zr.getWidth()
	}, $m.getHeight = function() {
		return this._zr.getHeight()
	}, $m.getDevicePixelRatio = function() {
		return this._zr.painter.dpr || window.devicePixelRatio || 1
	}, $m.getRenderedCanvas = function(t) {
		if(sd.canvasSupported) {
			t = t || {}, t.pixelRatio = t.pixelRatio || 1, t.backgroundColor = t.backgroundColor || this._model.get("backgroundColor");
			var e = this._zr;
			return e.painter.getRenderedCanvas(t)
		}
	}, $m.getSvgDataUrl = function() {
		if(sd.svgSupported) {
			var t = this._zr,
	...
	}, $m.getConnectedDataURL = function(t) {
		if(sd.canvasSupported) {
			var e = this.group,
				n = Math.min,
				r = Math.max,
	...
	}, $m.convertToPixel = x(qs, "convertToPixel"), $m.convertFromPixel = x(qs, "convertFromPixel"), $m.containPixel = function(t, e) {
		var n, i = this._model;
		return t = Gi(i, t), f(t, function(t, i) {
	...
	}, $m.getViewOfComponentModel = function(t) {
		return this._componentsMap[t.__viewId]
	}, $m.getViewOfSeriesModel = function(t) {
		return this._chartsMap[t.__viewId]
	};
	var Km = {
		prepareAndUpdate: function(t) {
			Zs(this), Km.update.call(this, t)
		},
		update: function(t) {
			var e = this._model,
				n = this._api,
				...
				a = this._scheduler;
			if(e) {
				e.restoreData(t), a.performSeriesTasks(e), r.create(e, n), a.performDataProcessorTasks(e, t), Ks(this, e), r.update(e, n), il(e), a.performVisualTasks(e, t), rl(this, e, n, t);
				var o = e.get("backgroundColor") || "transparent";
				if(sd.canvasSupported) i.setBackgroundColor(o);
				else {
					var s = Be(o);
		...
		updateTransform: function(t) {
			...
			if(e) {
				...
				e.eachSeries(function(r) {
					...
					setDirty: !0,
					dirtyMap: a
				}), ol(n, e, i, t, a), sl(e, this._api)
			}
		},
		updateView: function(t) {
			var e = this._model;
			e && (Ss.markUpdateMethod(t, "updateView"), il(e), this._scheduler.performVisualTasks(e, t, {
				setDirty: !0
			}), rl(this, this._model, this._api, t), sl(e, this._api))
		},
		updateVisual: function(t) {
			Km.update.call(this, t)
		},
	...
	$m.resize = function(t) {
		...
		if(this._loadingFX && this._loadingFX.resize(), e) {
			var n = e.resetOption("media"),
				i = t && t.silent;
			this[Ym] = !0, n && Zs(this), Km.update.call(this), this[Ym] = !1, Js.call(this, i), tl.call(this, i)
		}
	}, $m.showLoading = function(t, e) {
		if(Bm(t) && (e = t, t = ""), t = t || "default", this.hideLoading(), oy[t]) {
			var n = oy[t](this._api, e),
				i = this._zr;
			this._loadingFX = n, i.add(n)
		}
	}, $m.hideLoading = function() {
		this._loadingFX && this._zr.remove(this._loadingFX), this._loadingFX = null
	}, $m.makeActionFromEvent = function(t) {
		var e = o({}, t);
		return e.type = ty[t.type], e
	}, $m.dispatchAction = function(t, e) {
		if(Bm(e) || (e = {
				silent: !!e
			}), Jm[t.type] && this._model) {
			if(this[Ym]) return void this._pendingActions.push(t);
			Qs.call(this, t, e.silent), e.flush ? this._zr.flush(!0) : e.flush !== !1 && sd.browser.weChat && this._throttledZrFlush(), Js.call(this, e.silent), tl.call(this, e.silent)
		}
	}, $m.appendData = function(t) {
		var e = t.seriesIndex,
			n = this.getModel(),
			i = n.getSeriesByIndex(e);
		i.appendData(t), this._scheduler.unfinished = !0
	}, $m.on = js("on"), $m.off = js("off"), $m.one = js("one");
	var Qm = ["click", "dblclick", "mouseover", "mouseout", "mousemove", "mousedown", "mouseup", "globalout", "contextmenu"];
	$m._initEvents = function() {
		Lm(Qm, function(t) {
		...
		}, this), Lm(ty, function(t, e) {
			this._messageCenter.on(e, function(t) {
				this.trigger(e, t)
			}, this)
		}, this)
	}, $m.isDisposed = function() {
		...
		if(!this._disposed) {
			this._disposed = !0, Wi(this.getDom(), cy, "");
			var t = this._api,
				e = this._model;
	...
	var Jm = {},
		...
		dy = {},
		fy = gl;
	Cl(Vm, gm), _l(qv), wl(Hm, Zv), kl("default", xm), Sl({
		type: "highlight",
		event: "highlight",
		update: "highlight"
	}, H), Sl({
	...
	Nl.prototype = {
		...
		execute: function() {
			var t, e = this._old,
				...
				a = [],
				o = [];
			for(Fl(e, i, a, "_oldKeyGetter", this), Fl(n, r, o, "_newKeyGetter", this), t = 0; t < e.length; t++) {
				var s = a[t],
					l = r[s];
				if(null != l) {
					var h = l.length;
	...
	var gy = N(["tooltip", "label", "itemName", "itemId", "seriesName"]),
		vy = S,
		my = "undefined",
		yy = typeof window === my ? global : window,
		xy = "e\x00\x00",
		_y = {
			"float": typeof yy.Float64Array === my ? Array : yy.Float64Array,
			"int": typeof yy.Int32Array === my ? Array : yy.Int32Array,
			ordinal: Array,
			number: Array,
			time: Array
		},
		wy = typeof yy.Uint32Array === my ? Array : yy.Uint32Array,
		by = typeof yy.Uint16Array === my ? Array : yy.Uint16Array,
		Sy = ["hasItemOption", "_nameList", "_idList", "_calculationInfo", "_invertedIndicesMap", "_rawData", "_rawExtent", "_chunkSize", "_chunkCount", "_dimValueGetter", "_count", "_rawCount", "_nameDimIdx", "_idDimIdx"],
		My = function(t, e) {
			t = t || ["x", "y"];
	...
	Iy.type = "list", Iy.hasItemOption = !0, Iy.getDimension = function(t) {
	...
	}, Iy._initDataFromProvider = function(t, e) {
		if(!(t >= e)) {
			for(var n, i = this._chunkSize, r = this._rawData, a = this._storage, o = this.dimensions, s = this._dimensionInfos, l = this._nameList, h = this._idList, u = this._rawExtent, c = this._nameRepeatCount = {}, d = this._chunkCount, f = d - 1, p = 0; p < o.length; p++) {
				var g = o[p];
				u[g] || (u[g] = Jl());
				var v = s[g];
				...
				var y = a[g][f];
				if(y && y.length < i) {
					for(var x = new m(Math.min(e - f * i, i)), _ = 0; _ < y.length; _++) x[_] = y[_];
					a[g][f] = x
				}
				for(var w = d * i; e > w; w += i) a[g].push(new m(Math.min(e - w, i)));
			...
			for(var b = t; e > b; b++) {
				for(var S = r.getItem(b), M = Math.floor(b / i), I = b % i, w = 0; w < o.length; w++) {
					var g = o[w],
						T = a[g][M],
						C = this._dimValueGetter(S, g, b, w);
					T[I] = C, C < u[g][0] && (u[g][0] = C), C > u[g][1] && (u[g][1] = C)
				}
				if(!r.pure) {
					var D = l[b];
					S && !D && (null != n ? D = this._getNameFromStore(b) : null != S.name && (l[b] = D = S.name));
					var k = null == S ? null : S.id;
					null == k && null != D && (c[D] = c[D] || 0, k = D, c[D] > 0 && (k += "__ec__" + c[D]), c[D]++), null != k && (h[b] = k)
				}
			}!r.persistent && r.clean && r.clean(), this._rawCount = this._count = e, this._extent = {}, Ul(this)
		}
	}, Iy._getNameFromStore = function(t) {
		...
		if(null != e) {
			...
			if(o) return o.categories[t];
			var s = this._storage[a][i];
			return s && s[r]
		}
	}, Iy._getIdFromStore = function(t) {
		...
		return this._count
	}, Iy.getIndices = function() {
		if(this._indices) {
			var t = this._indices.constructor;
			return new t(this._indices.buffer, 0, this._count)
		}
		for(var t = Wl(this), e = new t(this.count()), n = 0; n < e.length; n++) e[n] = n;
		return e
	}, Iy.get = function(t, e) {
	...
	}, Iy.getApproximateExtent = function(t) {
		return t = this.getDimension(t), this._approximateExtent[t] || this.getDataExtent(t)
	}, Iy.setApproximateExtent = function(t, e) {
		e = this.getDimension(e), this._approximateExtent[e] = t.slice()
	}, Iy.getCalculationInfo = function(t) {
		return this._calculationInfo[t]
	}, Iy.setCalculationInfo = function(t, e) {
		vy(t) ? o(this._calculationInfo, t) : this._calculationInfo[t] = e
	}, Iy.getSum = function(t) {
		var e = this._storage[t],
			n = 0;
		if(e)
		...
		return n
	}, Iy.rawIndexOf = function(t, e) {
		var n = t && this._invertedIndicesMap[t],
			i = n[e];
		return null == i || isNaN(i) ? -1 : i
	}, Iy.indexOfName = function(t) {
		for(var e = 0, n = this.count(); n > e; e++)
			if(this.getName(e) === t) return e;
		return -1
	}, Iy.indexOfRawIndex = function(t) {
		...
		return -1
	}, Iy.indicesOfNearest = function(t, e, n) {
		var i = this._storage,
			r = i[t],
			a = [];
		if(!r) return a;
		...
		return a
	}, Iy.getRawIndex = Yl, Iy.getRawDataItem = function(t) {
		...
		return e
	}, Iy.getName = function(t) {
		var e = this.getRawIndex(t);
		return this._nameList[e] || this._getNameFromStore(e) || ""
	}, Iy.getId = function(t) {
		return Zl(this, this.getRawIndex(t))
	}, Iy.each = function(t, e, n, i) {
		if(this._count) {
			"function" == typeof t && (i = n, n = e, e = t, t = []), n = n || i || this, t = p($l(t), this.getDimension, this);
	...
	}, Iy.filterSelf = function(t, e, n, i) {
		if(this._count) {
			"function" == typeof t && (i = n, n = e, e = t, t = []), n = n || i || this, t = p($l(t), this.getDimension, this);
			for(var r = this.count(), a = Wl(this), o = new a(r), s = [], l = t.length, h = 0, u = t[0], c = 0; r > c; c++) {
			...
			return r > h && (this._indices = o), this._count = h, this._extent = {}, this.getRawIndex = this._indices ? ql : Yl, this
		}
	}, Iy.selectRange = function(t) {
		if(this._count) {
			var e = [];
			...
			if(i) {
				...
				return r > s && (this._indices = o), this._count = s, this._extent = {}, this.getRawIndex = this._indices ? ql : Yl, this
			}
		}
	}, Iy.mapArray = function(t, e, n, i) {
		"function" == typeof t && (i = n, n = e, e = t, t = []), n = n || i || this;
		var r = [];
		return this.each(t, function() {
			r.push(e && e.apply(this, arguments))
		}, n), r
	}, Iy.map = function(t, e, n, i) {
		n = n || i || this, t = p($l(t), this.getDimension, this);
		var r = Kl(this, t);
		r._indices = this._indices, r.getRawIndex = r._indices ? ql : Yl;
		...
		return r
	}, Iy.downSample = function(t, e, n, i) {
		for(var r = Kl(this, [t]), a = r._storage, o = [], s = Math.floor(1 / e), l = a[t], h = this.count(), u = this._chunkSize, c = r._rawExtent[t], d = new(Wl(this))(h), f = 0, p = 0; h > p; p += s) {
	...
	}, Iy.getItemModel = function(t) {
		var e = this.hostModel;
		return new Aa(this.getRawDataItem(t), e, e && e.ecModel)
	}, Iy.diff = function(t) {
		var e = this;
		return new Nl(t ? t.getIndices() : [], this.getIndices(), function(e) {
			return Zl(t, e)
		}, function(t) {
			return Zl(e, t)
		})
	}, Iy.getVisual = function(t) {
		var e = this._visual;
		return e && e[t]
	}, Iy.setVisual = function(t, e) {
		if(vy(t))
			for(var n in t) t.hasOwnProperty(n) && this.setVisual(n, t[n]);
		else this._visual = this._visual || {}, this._visual[t] = e
	}, Iy.setLayout = function(t, e) {
		if(vy(t))
			for(var n in t) t.hasOwnProperty(n) && this.setLayout(n, t[n]);
		else this._layout[t] = e
	}, Iy.getLayout = function(t) {
		return this._layout[t]
	}, Iy.getItemLayout = function(t) {
		return this._itemLayouts[t]
	}, Iy.setItemLayout = function(t, e, n) {
		this._itemLayouts[t] = n ? o(this._itemLayouts[t] || {}, e) : e
	}, Iy.clearItemLayouts = function() {
		this._itemLayouts.length = 0
	}, Iy.getItemVisual = function(t, e, n) {
		var i = this._itemVisuals[t],
			r = i && i[e];
		return null != r || n ? r : this.getVisual(e)
	}, Iy.setItemVisual = function(t, e, n) {
		var i = this._itemVisuals[t] || {},
			r = this.hasItemVisual;
		if(this._itemVisuals[t] = i, vy(e))
			for(var a in e) e.hasOwnProperty(a) && (i[a] = e[a], r[a] = !0);
		else i[e] = n, r[e] = !0
	}, Iy.clearAllVisual = function() {
		this._visual = {}, this._itemVisuals = [], this.hasItemVisual = {}
	};
	var Ty = function(t) {
		t.seriesIndex = this.seriesIndex, t.dataIndex = this.dataIndex, t.dataType = this.dataType
	};
	Iy.setItemGraphicEl = function(t, e) {
		var n = this.hostModel;
		e && (e.dataIndex = t, e.dataType = this.dataType, e.seriesIndex = n && n.seriesIndex, "group" === e.type && e.traverse(Ty, e)), this._graphicEls[t] = e
	}, Iy.getItemGraphicEl = function(t) {
		return this._graphicEls[t]
	}, Iy.eachItemGraphicEl = function(t, e) {
		f(this._graphicEls, function(n, i) {
			n && t && t.call(e, n, i)
		})
	}, Iy.cloneShallow = function(t) {
		if(!t) {
		...
		return t.getRawIndex = t._indices ? ql : Yl, t._extent = i(this._extent), t._approximateExtent = i(this._approximateExtent), t
	}, Iy.wrapMethod = function(t, e) {
		var n = this[t];
	...
	}, Iy.TRANSFERABLE_METHODS = ["cloneShallow", "downSample", "map"], Iy.CHANGABLE_METHODS = ["filterSelf", "selectRange"];
	var Cy = function(t, e) {
		return e = e || {}, th(e.coordDimensions || [], t, {
	...
	lh.prototype.parse = function(t) {
		return t
	}, lh.prototype.getSetting = function(t) {
		return this._setting[t]
	}, lh.prototype.contain = function(t) {
		var e = this._extent;
		return t >= e[0] && t <= e[1]
	}, lh.prototype.normalize = function(t) {
		var e = this._extent;
		return e[1] === e[0] ? .5 : (t - e[0]) / (e[1] - e[0])
	}, lh.prototype.scale = function(t) {
		var e = this._extent;
		return t * (e[1] - e[0]) + e[0]
	}, lh.prototype.unionExtent = function(t) {
		var e = this._extent;
		t[0] < e[0] && (e[0] = t[0]), t[1] > e[1] && (e[1] = t[1])
	}, lh.prototype.unionExtentFromData = function(t, e) {
		this.unionExtent(t.getApproximateExtent(e))
	}, lh.prototype.getExtent = function() {
		return this._extent.slice()
	}, lh.prototype.setExtent = function(t, e) {
		var n = this._extent;
		isNaN(t) || (n[0] = t), isNaN(e) || (n[1] = e)
	}, lh.prototype.getTicksLabels = function() {
		for(var t = [], e = this.getTicks(), n = 0; n < e.length; n++) t.push(this.getLabel(e[n]));
		return t
	}, lh.prototype.isBlank = function() {
		return this._isBlank
	}, lh.prototype.setBlank = function(t) {
		this._isBlank = t
	}, Yi(lh), Ki(lh, {
		registerWhenExtend: !0
	}), hh.createByAxisModel = function(t) {
		var e = t.option,
			n = e.data,
			i = n && p(n, ch);
		return new hh({
	...
	var Dy = hh.prototype;
	Dy.getOrdinal = function(t) {
		return uh(this).get(t)
	}, Dy.parseAndCollect = function(t) {
	...
	var ky = lh.prototype,
		Ay = lh.extend({
			...
			contain: function(t) {
				return t = this.parse(t), ky.contain.call(this, t) && null != this._ordinalMeta.categories[t]
			},
			normalize: function(t) {
				return ky.normalize.call(this, this.parse(t))
			},
			scale: function(t) {
				return Math.round(ky.scale.call(this, t))
			},
			getTicks: function() {
	...
	var Py = Fa,
		...
		Oy = lh.extend({
			...
			unionExtent: function(t) {
				var e = this._extent;
				t[0] < e[0] && (e[0] = t[0]), t[1] > e[1] && (e[1] = t[1]), Oy.prototype.setExtent.call(this, e[0], e[1])
			},
			getInterval: function() {
				return this._interval
			},
			setInterval: function(t) {
				this._interval = t, this._niceExtent = this._extent.slice(), this._intervalPrecision = fh(t)
			},
			getTicks: function() {
				return vh(this._interval, this._extent, this._niceExtent, this._intervalPrecision)
			},
			...
			getLabel: function(t, e) {
				if(null == t) return "";
				var n = e && e.precision;
				return null == n ? n = Va(t) || 0 : "auto" === n && (n = this._intervalPrecision), t = Ly(t, n, !0), Ja(t)
			},
			...
			niceExtent: function(t) {
				...
				t.fixMin || (e[0] = Ly(Math.floor(e[0] / r) * r)), t.fixMax || (e[1] = Ly(Math.ceil(e[1] / r) * r))
			}
		});
	Oy.create = function() {
		return new Oy
	...
	var By = "__ec_stack_",
		...
		Wy = Oy.extend({
			...
			niceExtent: function(t) {
				var e = this._extent;
				if(e[0] === e[1] && (e[0] -= Gy, e[1] += Gy), e[1] === -1 / 0 && 1 / 0 === e[0]) {
					var n = new Date;
					e[1] = +new Date(n.getFullYear(), n.getMonth(), n.getDate()), e[0] = e[1] - Gy
				}
				this.niceTicks(t.splitNumber, t.minInterval, t.maxInterval);
				var i = this._interval;
				t.fixMin || (e[0] = Fa(Ry(e[0] / i) * i)), t.fixMax || (e[1] = Fa(zy(e[1] / i) * i))
			},
			niceTicks: function(t, e, n) {
				t = t || 10;
				var i = this._extent,
				...
				var d = this.getSetting("useUTC") ? 0 : 60 * new Date(+i[0] || +i[1]).getTimezoneOffset() * 1e3,
					f = [Math.round(zy((i[0] - d) / h) * h + d), Math.round(Ry((i[1] - d) / h) * h + d)];
				gh(f, i), this._stepLvl = l, this._interval = h, this._niceExtent = f
			},
			parse: function(t) {
				return +Ya(t)
			}
	...
	f(["contain", "normalize"], function(t) {
		Wy.prototype[t] = function(e) {
			return Ey[t].call(this, this.parse(e))
		}
	});
	var Xy = [
		["hh:mm:ss", Ny],
	...
	var jy = lh.prototype,
		...
		Jy = lh.extend({
			...
			$constructor: function() {
				lh.apply(this, arguments), this._originalScale = new Oy
			},
			getTicks: function() {
				var t = this._originalScale,
					e = this._extent,
					n = t.getExtent();
				return p(Uy.getTicks.call(this), function(i) {
					var r = Fa(Ky(this.base, i));
					return r = i === e[0] && t.__fixMin ? bh(r, n[0]) : r, r = i === e[1] && t.__fixMax ? bh(r, n[1]) : r
				}, this)
			},
			getLabel: Uy.getLabel,
			scale: function(t) {
				return t = jy.scale.call(this, t), Ky(this.base, t)
			},
			setExtent: function(t, e) {
				var n = this.base;
				t = Qy(t) / Qy(n), e = Qy(e) / Qy(n), Uy.setExtent.call(this, t, e)
			},
			getExtent: function() {
				var t = this.base,
					e = jy.getExtent.call(this);
				e[0] = Ky(t, e[0]), e[1] = Ky(t, e[1]);
				var n = this._originalScale,
					i = n.getExtent();
				return n.__fixMin && (e[0] = bh(e[0], i[0])), n.__fixMax && (e[1] = bh(e[1], i[1])), e
			},
			unionExtent: function(t) {
				this._originalScale.unionExtent(t);
				var e = this.base;
				t[0] = Qy(t[0]) / Qy(e), t[1] = Qy(t[1]) / Qy(e), jy.unionExtent.call(this, t)
			},
			unionExtentFromData: function(t, e) {
				this.unionExtent(t.getApproximateExtent(e))
			},
			niceTicks: function(t) {
				...
				if(!(1 / 0 === n || 0 >= n)) {
					...
					var a = [Fa($y(e[0] / i) * i), Fa(Zy(e[1] / i) * i)];
					this._interval = i, this._niceExtent = a
				}
			},
			niceExtent: function(t) {
				Uy.niceExtent.call(this, t);
				var e = this._originalScale;
				e.__fixMin = t.fixMin, e.__fixMax = t.fixMax
			}
		});
	f(["contain", "normalize"], function(t) {
		Jy.prototype[t] = function(e) {
			return e = Qy(e) / Qy(this.base), jy[t].call(this, e)
		}
	}), Jy.create = function() {
		return new Jy
	};
	var tx = {
			getFormattedLabels: function() {
				return kh(this.axis, this.get("axisLabel.formatter"))
			},
			getMin: function(t) {
				var e = this.option,
	...
	var lx = Vr({
			...
			buildPath: function(t, e, n) {
				var i = e.symbolType,
					r = sx[i];
				"none" !== e.symbolType && (r || (i = "rect", r = sx[i]), ox[i](e.x, e.y, e.width, e.height, r.shape), r.buildPath(t, r.shape, n))
			}
		}),
		hx = {
			isDimensionStacked: rh,
			enableDataStack: ih
		},
		ux = (Object.freeze || Object)({
			...
			dataStack: hx,
			createScale: Bh,
			mixinAxisModelCommonMethods: Eh,
	...
	gx.prototype = {
		...
		dataToCoord: function(t, e) {
			var n = this._extent,
				i = this.scale;
			return t = i.normalize(t), this.onBand && "ordinal" === i.type && (n = n.slice(), Gh(n, i.count())), fx(t, px, n, e)
		},
		coordToData: function(t, e) {
			var n = this._extent,
				i = this.scale;
			this.onBand && "ordinal" === i.type && (n = n.slice(), Gh(n, i.count()));
			var r = fx(t, n, px, e);
		...
		getBands: function() {
			for(var t = this.getExtent(), e = [], n = this.scale.count(), i = t[0], r = t[1], a = r - i, o = 0; n > o; o++) e.push([a * o / n + i, a * (o + 1) / n + i]);
			return e
		},
		...
		getLabelInterval: function() {
			...
			if(!t) {
				...
				t = n.get("interval"), "category" !== this.type || null != t && "auto" !== t || (t = Dh(p(this.scale.getTicks(), this.dataToCoord, this), e.getFormattedLabels(), n.getFont(), this.getRotate ? this.getRotate() : this.isHorizontal && !this.isHorizontal() ? 90 : 0, n.get("rotate"))), this._labelInterval = t
			}
			return t
		}
	};
	...
	yx.prototype = {
		...
		clampData: function(t, e) {
			...
			return e = e || [], e[0] = Math.min(Math.max(Math.min(n[0], n[1]), t[0]), Math.max(n[0], n[1])), e[1] = Math.min(Math.max(Math.min(i[0], i[1]), t[1]), Math.max(i[0], i[1])), e
		},
	...
	var xx = function(t, e, n, i, r) {
		gx.call(this, t, e, n), this.type = i || "value", this.position = r || "bottom"
	};
	xx.prototype = {
		constructor: xx,
		index: 0,
	...
	bx.categoryAxis = r({
		...
		min: "dataMin",
		max: "dataMax"
	}, bx.valueAxis), bx.logAxis = s({
		scale: !0,
		logBase: 10
	}, bx.valueAxis);
	var Sx = ["value", "category", "time", "log"],
		Mx = function(t, e, n, i) {
			f(Sx, function(o) {
				e.extend({
					type: t + "Axis." + o,
					...
					optionUpdated: function() {
						var t = this.option;
						"category" === t.type && (this.__ordinalMeta = hh.createByAxisModel(this))
					},
					...
					defaultOption: a([{}, bx[o + "Axis"], i], !0)
				})
			}), yv.registerSubTypeDefaulter(t + "Axis", x(n, t))
		},
		Ix = yv.extend({
			type: "cartesian2dAxis",
			axis: null,
			init: function() {
				Ix.superApply(this, "init", arguments), this.resetRange()
			},
			mergeOption: function() {
				Ix.superApply(this, "mergeOption", arguments), this.resetRange()
			},
			restoreData: function() {
				Ix.superApply(this, "restoreData", arguments), this.resetRange()
			},
	...
	Mx("x", Ix, Xh, Tx), Mx("y", Ix, Xh, Tx), yv.extend({
		type: "grid",
	...
	var Cx = f,
		...
		kx = Ih,
		Ax = qh.prototype;
	Ax.type = "grid", Ax.axisPointerEnabled = !0, Ax.getRect = function() {
		return this._rect
	}, Ax.update = function(t, e) {
		var n = this._axesMap;
		this._updateScale(t, this.model), Cx(n.x, function(t) {
			kx(t.scale, t.model)
		}), Cx(n.y, function(t) {
			kx(t.scale, t.model)
		}), Cx(n.x, function(t) {
	...
	}, Ax.resize = function(t, e, n) {
		function i() {
			Cx(a, function(t) {
				var e = t.isHorizontal(),
					n = e ? [0, r.width] : [0, r.height],
					i = t.inverse ? 1 : 0;
				t.setExtent(n[i], n[1 - i]), Kh(t, e ? r.x : r.y)
			})
		}
		...
		i(), !n && t.get("containLabel") && (Cx(a, function(t) {
	...
	}, Ax.getCartesians = function() {
		return this._coordsList.slice()
	}, Ax.convertToPixel = function(t, e, n) {
		var i = this._findConvertTarget(t, e);
		return i.cartesian ? i.cartesian.dataToPoint(n) : i.axis ? i.axis.toGlobalCoord(i.axis.dataToCoord(n)) : null
	}, Ax.convertFromPixel = function(t, e, n) {
		var i = this._findConvertTarget(t, e);
		return i.cartesian ? i.cartesian.pointToData(n) : i.axis ? i.axis.coordToData(i.axis.toLocalCoord(n)) : null
	}, Ax._findConvertTarget = function(t, e) {
	...
	}, Ax.containPoint = function(t) {
		var e = this._coordsList[0];
		return e ? e.containPoint(t) : void 0
	}, Ax._initCartesian = function(t, e) {
		function n(n) {
			return function(o, s) {
				if(jh(o, t, e)) {
					...
					var h = new xx(n, Th(o), [0, 0], o.get("type"), l),
						u = "category" === h.type;
					h.onBand = u && o.get("boundaryGap"), h.inverse = o.get("inverse"), h.onZero = o.get("axisLine.onZero"), h.onZeroAxisIndex = o.get("axisLine.onZeroAxisIndex"), o.axis = h, h.model = o, h.grid = this, h.index = s, this._axesList.push(h), r[n][s] = h, a[n]++
				}
			}
		}
		var i = {
		...
		return e.eachComponent("xAxis", n("x"), this), e.eachComponent("yAxis", n("y"), this), a.x && a.y ? (this._axesMap = r, void Cx(r.x, function(e, n) {
			Cx(r.y, function(i, r) {
				var a = "x" + n + "y" + r,
					o = new Wh(a);
	...
	}, Ax._updateScale = function(t, e) {
		function n(t, e) {
			Cx(t.mapDimension(e.dim, !0), function(n) {
	...
	}, Ax.getTooltipAxes = function(t) {
		var e = [],
			n = [];
		return Cx(this.getCartesians(), function(i) {
	...
	}, qh.dimensions = qh.prototype.dimensions = Wh.prototype.dimensions, No.register("cartesian2d", qh);
	var Lx = rm.extend({
		type: "series.__base_bar__",
		getInitialData: function() {
			return ah(this.getSource(), this)
		},
	...
	var Ox = mp([
		...
		Ex = ["itemStyle", "barBorderWidth"];
	o(Aa.prototype, Bx), Ol({
		type: "bar",
		...
		_render: function(t) {
			...
			i.diff(r).add(function(r) {
				...
				h ? wa(h, {
					shape: c
				}, s, o) : h = zx[a.type](i, o, u, c, e, s, !0), i.setItemGraphicEl(o, h), n.add(h), au(h, i, o, u, c, t, e, "polar" === a.type)
			}).remove(function(t) {
				var e = r.getItemGraphicEl(t);
				"cartesian2d" === a.type ? e && iu(t, s, e) : e && ru(t, s, e)
		...
		remove: function(t) {
			...
			t.get("animation") ? n && n.eachItemGraphicEl(function(e) {
				"sector" === e.type ? ru(e.dataIndex, t, e) : iu(e.dataIndex, t, e)
			}) : e.removeAll()
		}
	});
	var zx = {
			cartesian2d: function(t, e, n, i, r, a, s) {
				...
				if(a) {
					var h = l.shape,
						u = r ? "height" : "width",
						c = {};
					h[u] = 0, c[u] = i[u], qg[s ? "updateProps" : "initProps"](l, {
						shape: c
					}, a, e)
				}
				return l
			...
			polar: function(t, e, n, i, r, a, o) {
				...
				if(a) {
					var u = h.shape,
						c = r ? "r" : "endAngle",
						d = {};
					u[c] = r ? 0 : i.startAngle, d[c] = i[c], qg[o ? "updateProps" : "initProps"](h, {
						shape: d
					}, a, e)
				}
				return h
	...
	var Hx = {
					...
					if("number" == typeof u && (u = [u, u]), null != l) {
						...
						f([{
							...
							if("none" !== l[n] && null != l[n]) {
								var i = Lh(l[n], -c / 2, -d / 2, c, d, s.stroke, !0),
									a = e.r + e.offset,
			...
			axisName: function() {
				...
				if(n) {
					...
					null != d && (d = d * Nx / 180);
					var f;
					fu(r) ? i = Gx(t.rotation, null != d ? d : t.rotation, a) : (i = lu(t, r, d || 0, h), f = t.axisNameAvailableWidth, null != f && (f = Math.abs(f / Math.sin(i.rotation)), !isFinite(f) && (f = null)));
					var p = s.getFont(),
						g = e.get("nameTruncate", !0) || {},
						v = g.ellipsis,
						m = D(t.nameTruncateMaxWidth, g.maxWidth, f),
						y = null != v && null != m ? hv(n, m, p, v, {
							minChar: 2,
					...
					}), e.get("triggerEvent") && (b.eventData = su(e), b.eventData.targetType = "axisName", b.eventData.name = n), this._dumbGroup.add(b), b.updateTransform(), this.group.add(b), b.decomposeTransform()
				}
			}
		},
		Gx = Fx.innerTextLayout = function(t, e, n) {
			var i, r, a = ja(e - t);
			return Ua(a) ? (r = n > 0 ? "top" : "bottom", i = "center") : Ua(a - Nx) ? (r = n > 0 ? "bottom" : "top", i = "center") : (r = "middle", i = a > 0 && Nx > a ? n > 0 ? "right" : "left" : n > 0 ? "left" : "right"), {
				rotation: a,
				textAlign: i,
				textVerticalAlign: r
			}
		},
		Vx = Fx.ifIgnoreOnTick = function(t, e, n, i, r, a) {
			if(0 === e && r || e === i - 1 && a) return !1;
			var o, s = t.scale;
			return "ordinal" === s.type && ("function" == typeof n ? (o = s.getTicks()[e], !n(o, s.getLabel(o))) : e % (n + 1))
		},
		Wx = Fx.getInterval = function(t, e) {
		...
		Ux = Pl({
			...
			render: function(t, e, n, i) {
				this.axisPointerClass && bu(t), Ux.superApply(this, "render", arguments), Cu(this, t, e, n, i, !0)
			},
			...
			remove: function(t, e) {
				...
				n && n.remove(e), Ux.superApply(this, "remove", arguments)
			},
			dispose: function(t, e) {
				Du(this, e), Ux.superApply(this, "dispose", arguments)
			}
		}),
		Yx = [];
	Ux.registerAxisPointerClass = function(t, e) {
		Yx[t] = e
	}, Ux.getAxisPointerClass = function(t) {
		return t && Yx[t]
	};
	var qx = Fx.ifIgnoreOnTick,
		Zx = Fx.getInterval,
		$x = ["axisLine", "axisTickLabel", "axisName"],
		Kx = ["splitArea", "splitLine"],
		Qx = Ux.extend({
			type: "cartesianAxis",
			...
			render: function(t, e, n, i) {
				...
				if(this._axisGroup = new cf, this.group.add(this._axisGroup), t.get("show")) {
					var a = t.getCoordSysModel(),
						o = ku(a, t),
						s = new Fx(t, o);
					f($x, s.add, s), this._axisGroup.add(s.getGroup()), f(Kx, function(e) {
						t.get(e + ".show") && this["_" + e](t, a, o.labelInterval)
					}, this), Ta(r, this._axisGroup, t), Qx.superCall(this, "render", t, e, n, i)
				}
			},
			_splitLine: function(t, e, n) {
				...
				if(!i.scale.isBlank()) {
					var r = t.getModel("splitLine"),
						...
						l = Zx(r, n);
					o = _(o) ? o : [o];
					for(var h = e.coordinateSystem.getRect(), u = i.isHorizontal(), c = 0, d = i.getTicksCoords(), f = i.scale.getTicks(), p = t.get("axisLabel.showMinLabel"), g = t.get("axisLabel.showMaxLabel"), v = [], m = [], y = a.getLineStyle(), x = 0; x < d.length; x++)
						if(!qx(i, x, l, d.length, p, g)) {
							var w = i.toGlobalCoord(d[x]);
							u ? (v[0] = w, v[1] = h.y, m[0] = w, m[1] = h.y + h.height) : (v[0] = h.x, v[1] = w, m[0] = h.x + h.width, m[1] = w);
							var b = c++ % o.length;
							this._axisGroup.add(new Bg(qr({
								anid: "line_" + f[x],
								shape: {
									x1: v[0],
									y1: v[1],
			...
			_splitArea: function(t, e, n) {
				...
				if(!i.scale.isBlank()) {
					var r = t.getModel("splitArea"),
						...
						g = a.getAreaStyle();
					o = _(o) ? o : [o];
					for(var v = t.get("axisLabel.showMinLabel"), m = t.get("axisLabel.showMaxLabel"), y = 1; y < h.length; y++)
						if(!(qx(i, y, p, h.length, v, m) && y < h.length - 1)) {
							var x, w, b, S, M = i.toGlobalCoord(h[y]);
							i.isHorizontal() ? (x = c, w = l.y, b = M - x, S = l.height) : (x = l.x, w = d, b = l.width, S = M - w);
							var I = f++ % o.length;
							this._axisGroup.add(new Og({
								anid: "area_" + u[y],
								shape: {
									x: x,
									y: w,
	...
	var Jx = Lu.prototype;
	Jx._createSymbol = function(t, e, n, i) {
		this.removeAll();
		...
		a.attr({
			...
			culling: !0,
			scale: Pu(i)
		}), a.drift = Ou, this._symbolType = t, this.add(a)
	}, Jx.stopSymbolAnimation = function(t) {
		this.childAt(0).stopAnimation(t)
	}, Jx.getSymbolPath = function() {
		return this.childAt(0)
	}, Jx.getScale = function() {
		return this.childAt(0).scale
	}, Jx.highlight = function() {
		this.childAt(0).trigger("emphasis")
	}, Jx.downplay = function() {
		this.childAt(0).trigger("normal")
	}, Jx.setZ = function(t, e) {
		var n = this.childAt(0);
		n.zlevel = t, n.z = e
	}, Jx.setDraggable = function(t) {
		var e = this.childAt(0);
		e.draggable = t, e.cursor = t ? "move" : "pointer"
	}, Jx.updateData = function(t, e, n) {
		this.silent = !1;
		var i = t.getItemVisual(e, "symbol") || "circle",
			r = t.hostModel,
			a = Au(t, e),
			o = i !== this._symbolType;
		if(o) this._createSymbol(i, t, e, a);
		else {
		...
		if(this._updateCommon(t, e, a, n), o) {
			...
			}), s.scale = [0, 0], l && (s.style.opacity = 0), ba(s, h, r, e)
		}
		this._seriesModel = r
	};
	var t_ = ["itemStyle"],
		e_ = ["emphasis", "itemStyle"],
		n_ = ["label"],
		i_ = ["emphasis", "label"];
	Jx._updateCommon = function(t, e, n, i) {
		function r(e) {
			return _ ? t.getName(e) : tu(t, e)
		}
		...
		if(!i || t.hasItemOption) {
			...
			h = m.getModel(t_).getItemStyle(["color"]), u = m.getModel(e_).getItemStyle(), c = m.getShallow("symbolRotate"), d = m.getShallow("symbolOffset"), f = m.getModel(n_), p = m.getModel(i_), g = m.getShallow("hoverAnimation"), v = m.getShallow("cursor")
		} else u = o({}, u);
		var y = a.style;
	...
	r_.updateData = function(t, e) {
		...
		r || n.removeAll(), t.diff(r).add(function(i) {
			...
			var h = r.getItemGraphicEl(l),
				u = t.getItemLayout(s);
			return Eu(t, u, s, e) ? (h ? (h.updateData(t, s, o), wa(h, {
				position: u
	...
	}, r_.isPersistent = function() {
		return !0
	}, r_.updateLayout = function() {
		var t = this._data;
		t && t.eachItemGraphicEl(function(e, n) {
			var i = t.getItemLayout(n);
			e.attr("position", i)
		})
	}, r_.incrementalPrepareUpdate = function(t) {
		this._seriesScope = Ru(t), this._data = null, this.group.removeAll()
	}, r_.incrementalUpdate = function(t, e, n) {
		function i(t) {
	...
	var a_ = function(t, e, n, i, r, a, o, s) {
			for(var l = Gu(t, e), h = [], u = [], c = [], d = [], f = [], p = [], g = [], v = Nu(r, e, o), m = Nu(a, t, s), y = 0; y < l.length; y++) {
				var x = l[y],
					_ = !0;
				switch(x.cmd) {
					case "=":
					...
					case "+":
						var S = x.idx;
						h.push(r.dataToPoint([e.get(v.dataDimsForPoint[0], S), e.get(v.dataDimsForPoint[1], S)])), u.push(e.getItemLayout(S).slice()), c.push(Hu(v, r, e, S)), d.push(i[S]), g.push(e.getRawIndex(S));
						break;
					case "-":
						var S = x.idx,
							M = t.getRawIndex(S);
						M !== S ? (h.push(t.getItemLayout(S)), u.push(a.dataToPoint([t.get(m.dataDimsForPoint[0], S), t.get(m.dataDimsForPoint[1], S)])), c.push(n[S]), d.push(Hu(m, a, t, S)), g.push(M)) : _ = !1
				}
			...
			for(var I = [], T = [], C = [], D = [], k = [], y = 0; y < p.length; y++) {
				var S = p[y];
				I[y] = h[S], T[y] = u[S], C[y] = c[S], D[y] = d[S], k[y] = f[S]
			}
			return {
				current: I,
				next: T,
		...
		f_ = Pr.extend({
			...
			buildPath: function(t, e) {
				var n = e.points,
					i = 0,
					r = n.length,
					a = Yu(n, e.smoothConstraint);
				if(e.connectNulls) {
					for(; r > 0 && Vu(n[r - 1]); r--);
					for(; r > i && Vu(n[i]); i++);
				}
				for(; r > i;) i += Wu(t, n, i, r, r, 1, a.min, a.max, e.smooth, e.smoothMonotone, e.connectNulls) + 1
			}
		}),
		p_ = Pr.extend({
			type: "ec-polygon",
			...
			buildPath: function(t, e) {
				var n = e.points,
					...
					a = n.length,
					o = e.smoothMonotone,
					s = Yu(n, e.smoothConstraint),
					l = Yu(i, e.smoothConstraint);
				if(e.connectNulls) {
					for(; a > 0 && Vu(n[a - 1]); a--);
					for(; a > r && Vu(n[r]); r++);
				}
				for(; a > r;) {
					var h = Wu(t, n, r, a, a, 1, s.min, s.max, e.smooth, o, e.connectNulls);
					Wu(t, i, r + h - 1, h, a, -1, l.min, l.max, e.stackedOnSmooth, o, e.connectNulls), r += h + 1, t.closePath()
				}
			}
		});
	Ss.extend({
		...
		render: function(t, e, n) {
			...
			var M = !u && t.get("step");
			if(f && c.type === i.type && M === this._step) {
				m && !p ? p = this._newPolygon(h, _, i, v) : p && !m && (g.remove(p), p = this._polygon = null);
				var I = tc(i, !1, t);
				g.setClipPath(I), w && d.updateData(a, {
					isIgnore: b,
					clipShape: I
				}), a.eachItemGraphicEl(function(t) {
					t.stopAnimation(!0)
				}), qu(this._stackedOnPoints, _) && qu(this._points, h) || (v ? this._updateAnimation(a, _, i, n, M, y) : (M && (h = ec(h, i, M), _ = ec(_, i, M)), f.setShape({
					points: h
				}), p && p.setShape({
					points: h,
					stackedOnPoints: _
				...
				isIgnore: b,
				clipShape: tc(i, !1, t)
			}), M && (h = ec(h, i, M), _ = ec(_, i, M)), f = this._newPolyline(h, i, v), m && (p = this._newPolygon(h, _, i, v)), g.setClipPath(tc(i, !0, t));
			var T = nc(a, i) || a.getVisual("color");
			...
			var C = t.get("smooth");
			if(C = Zu(t.get("smooth")), f.setShape({
					smooth: C,
				...
				p.useStyle(s(l.getAreaStyle(), {
					...
					opacity: .7,
					lineJoin: "bevel"
				})), D && (k = Zu(D.get("smooth"))), p.setShape({
					smooth: C,
					stackedOnSmooth: k,
					smoothMonotone: t.get("smoothMonotone"),
					connectNulls: t.get("connectNulls")
		...
		highlight: function(t, e, n, i) {
			...
			if(!(a instanceof Array) && null != a && a >= 0) {
				...
				if(!o) {
					...
					if(!s) return;
					o = new Lu(r, a), o.position = s, o.setZ(t.get("zlevel"), t.get("z")), o.ignore = isNaN(s[0]) || isNaN(s[1]), o.__temp = !0, r.setItemGraphicEl(a, o), o.stopSymbolAnimation(!0), this.group.add(o)
				}
				o.highlight()
			} else Ss.prototype.highlight.call(this, t, e, n, i)
		},
		downplay: function(t, e, n, i) {
			var r = t.getData(),
				a = Fi(r, i);
			...
			} else Ss.prototype.downplay.call(this, t, e, n, i)
		},
		_newPolyline: function(t) {
			var e = this._polyline;
			return e && this._lineGroup.remove(e), e = new f_({
				shape: {
					points: t
				},
				silent: !0,
		...
		_newPolygon: function(t, e) {
			var n = this._polygon;
			return n && this._lineGroup.remove(n), n = new p_({
				shape: {
					points: t,
					stackedOnPoints: e
				},
		...
		_getSymbolIgnoreFunc: function(t, e) {
			...
			return n && n.isLabelIgnored ? y(n.isLabelIgnored, n) : void 0
		},
		_updateAnimation: function(t, e, n, i, r, a) {
			var o = this._polyline,
				s = this._polygon,
				l = t.hostModel,
				h = a_(this._data, t, this._stackedOnPoints, e, this._coordSys, n, this._valueOrigin, a),
				u = h.current,
				c = h.stackedOnCurrent,
				d = h.next,
				f = h.stackedOnNext;
			r && (u = ec(h.current, n, r), c = ec(h.stackedOnCurrent, n, r), d = ec(h.next, n, r), f = ec(h.stackedOnNext, n, r)), o.shape.__points = h.current, o.shape.points = u, wa(o, {
				shape: {
					points: d
				}
			}, l), s && (s.setShape({
				...
				reset: function(t, i) {
					function r(e, n) {
						...
						if(e.hasItemOption) {
							...
							null != o && e.setItemVisual(n, "symbol", o), null != l && e.setItemVisual(n, "symbolSize", l)
						}
					}
					var a = t.getData(),
						o = t.get("symbol") || e,
					...
					if(a.setVisual({
						...
						return {
							dataEach: a.hasItemOption || l ? r : null
						}
					}
				}
			}
				...
				reset: function(t) {
					...
					if(i) {
						var o = p(i.dimensions, function(t) {
							...
							s = o.length;
						return rh(n, o[0], o[1]) && (o[0] = n.getCalculationInfo("stackResultDimension")), rh(n, o[1], o[0]) && (o[1] = n.getCalculationInfo("stackResultDimension")), s && {
							progress: e
						}
					}
				}
			...
			return {
				...
				reset: function(t) {
					...
					if("cartesian2d" === i.type && n) {
						...
						if(l > 1) {
							var h;
							"string" == typeof n ? h = m_[n] : "function" == typeof n && (h = n), h && t.setData(e.downSample(a.dim, 1 / l, h, y_))
						}
					}
				}
			}
		};
	Cl(g_("line", "circle", "line")), Tl(v_("line")), wl(Um.PROCESSOR.STATISTIC, x_("line"));
	var __ = function(t, e, n) {
			e = _(e) && {
				coordDimensions: e
			} || o({}, e);
			var i = t.getSource(),
		...
		b_ = Ll({
			type: "series.pie",
			init: function(t) {
				b_.superApply(this, "init", arguments), this.legendDataProvider = function() {
					return this.getRawData()
				}, this.updateSelectedMap(this._createSelectableList()), this._defaultLabelLine(t)
			},
			mergeOption: function(t) {
				b_.superCall(this, "mergeOption", t), this.updateSelectedMap(this._createSelectableList())
			},
			getInitialData: function() {
			...
			getDataParams: function(t) {
				var e = this.getData(),
					n = b_.superCall(this, "getDataParams", t),
					i = [];
	...
	S_.updateData = function(t, e, n) {
		...
		p && a.attr("cursor", p), rc(this, t.getItemLayout(e), l.isSelected(null, e), l.get("selectedOffset"), l.get("animation")), a.off("mouseover").off("mouseout").off("emphasis").off("normal"), h.get("hoverAnimation") && l.isAnimationEnabled() && a.on("mouseover", i).on("mouseout", r).on("emphasis", i).on("normal", r), this._updateLabel(t, e), ha(this)
	...
	var M_ = (Ss.extend({
			...
			f(e, function(e) {
				e.update = "updateView", Sl(e, function(n, i) {
					var r = {};
		...
		T_ = function(t, e, n, i) {
			...
			o.each(function(n) {
				...
				var k = p.getFont(),
					A = p.get("rotate") ? 0 > _ ? -x + Math.PI : -x : 0,
			...
			}), !l && t.get("avoidLabelOverlap") && sc(s, r, a, e, n, i)
		},
		C_ = 2 * Math.PI,
		D_ = Math.PI / 180,
		k_ = function(t, e, n) {
			e.eachSeriesByType(t, function(t) {
				...
				if(e.each(i, function(t, n) {
						...
						i = "area" !== x ? 0 === v && w ? m : t * m : C_ / g, p > i ? (i = p, S -= p) : M += t;
						var r = I + T * i;
						e.setItemLayout(n, {
							angle: i,
							startAngle: I,
	...
	M_("pie", [{
		...
		event: "pieunselected",
		method: "unSelect"
	}]), Cl(I_("pie")), Tl(x(k_, "pie")), wl(A_("pie")), Al({
		type: "title",
		layoutMode: {
			type: "box",
			ignoreSize: !0
	...
	var P_ = Al({
		...
		mergeOption: function(t) {
			P_.superCall(this, "mergeOption", t)
		},
		optionUpdated: function() {
	...
	Sl("legendToggleSelect", "legendselectchanged", x(lc, "toggleSelected")), Sl("legendSelect", "legendselected", x(lc, "select")), Sl("legendUnSelect", "legendunselected", x(lc, "unSelect"));
	var L_ = x,
		O_ = f,
		B_ = cf,
		E_ = Pl({
			...
			newlineDisabled: !1,
			init: function() {
				this.group.add(this._contentGroup = new B_), this._backgroundEl
			},
			...
			render: function(t, e, n) {
				if(this.resetInner(), t.get("show", !0)) {
					...
					this.group.attr("position", [u.x - h.x, u.y - h.y]), this.group.add(this._backgroundEl = hc(h, t))
				}
			},
			resetInner: function() {
			...
			renderInner: function(t, e, n, i) {
				...
				O_(e.getData(), function(s, l) {
					var h = s.get("name");
					if(!this.newlineDisabled && ("" === h || "\n" === h)) return void r.add(new B_({
						newline: !0
					}));
					...
					if(!a.get(h))
						if(u) {
							...
							var f = c.getVisual("legendSymbol") || "roundRect",
								...
								g = this._createItem(h, l, s, e, f, p, t, d, o);
							g.on("click", L_(uc, h, i)).on("mouseover", L_(cc, u, null, i)).on("mouseout", L_(dc, u, null, i)), a.set(h, !0)
							...
							if(!a.get(h) && n.legendDataProvider) {
								...
								var c = r.getItemVisual(u, "color"),
									d = "roundRect",
									f = this._createItem(h, l, s, e, d, null, t, c, o);
								f.on("click", L_(uc, h, i)).on("mouseover", L_(cc, n, h, i)).on("mouseout", L_(dc, n, h, i)), a.set(h, !0)
							}
						}, this)
				}, this)
			},
			_createItem: function(t, e, n, i, r, a, s, l, h) {
				var u = i.get("itemWidth"),
					...
					y = m.parentModel;
				if(r = v || r, p.add(Lh(r, 0, 0, u, c, f ? l : d, !0)), !v && a && (a !== r || "none" == a)) {
					var x = .8 * c;
					"none" === a && (a = "circle"), p.add(Lh(a, (u - x) / 2, (c - x) / 2, x, x, f ? l : d))
				}
				var _ = "left" === s ? u + 5 : -5,
					w = s,
					b = i.get("formatter"),
					S = t;
				"string" == typeof b && b ? S = b.replace("{name}", null != t ? t : "") : "function" == typeof b && (S = b(t)), p.add(new Sg({
					style: ca({}, g, {
						text: S,
						x: _,
						y: c / 2,
				...
				return p.add(M), p.eachChild(function(t) {
					t.silent = !0
				}), M.silent = !h, this.getContentGroup().add(p), ha(p), p.__legendDataIndex = e, p
			},
			layoutInner: function(t, e, n) {
				var i = this.getContentGroup();
				gv(t.get("orient"), i, t.get("itemGap"), n.width, n.height);
	...
	wl(z_), yv.registerSubTypeDefaulter("legend", function() {
		return "plain"
	});
	var R_ = P_.extend({
			type: "legend.scroll",
			...
			init: function(t, e, n, i) {
				var r = co(t);
				R_.superCall(this, "init", t, e, n, i), fc(this, t, r)
			},
			mergeOption: function(t, e) {
				R_.superCall(this, "mergeOption", t, e), fc(this, this.option, t)
			},
			getOrient: function() {
		...
		G_ = E_.extend({
			...
			newlineDisabled: !0,
			init: function() {
				G_.superCall(this, "init"), this._currentIndex = 0, this.group.add(this._containerGroup = new N_), this._containerGroup.add(this.getContentGroup()), this.group.add(this._controllerGroup = new N_), this._showController
			},
			resetInner: function() {
				G_.superCall(this, "resetInner"), this._controllerGroup.removeAll(), this._containerGroup.removeClipPath(), this._containerGroup.__rectSize = null
			},
			renderInner: function(t, e, n, i) {
				function r(t, n) {
					var r = t + "DataIndex",
				...
				var a = this;
				G_.superCall(this, "renderInner", t, e, n, i);
			...
			layoutInner: function(t, e, n) {
				var i = this.getContentGroup(),
					...
					l = F_[1 - o],
					h = H_[1 - o];
				gv(t.get("orient"), i, t.get("itemGap"), o ? n.width : null, o ? null : n.height), gv("horizontal", a, t.get("pageButtonItemGap", !0));
				...
				if(y[s] = d ? n[s] : u[s], y[l] = Math.max(u[l], c[l]), y[h] = Math.min(0, c[h] + g[1 - o]), r.__rectSize = n[s], d) {
					...
					x[s] = Math.max(n[s] - c[s] - v, 0), x[l] = y[l], r.setClipPath(new Og({
						shape: x
					})), r.__rectSize = x[s]
	...
	var V_ = function(t, e) {
		...
		U_ = function(t, e, n) {
			...
			if(s) {
				...
				W_(s.coordSysMap, function(t, e) {
					var n = l || t.containPoint(r);
					W_(s.coordSysAxesInfo[e], function(t) {
						var e = t.axis,
							i = wc(h, t);
						if(!c && n && (!h || i)) {
							var a = i && i.value;
							null != a || l || (a = e.pointToData(r)), null != a && pc(t, a, g, !1, d)
						}
					})
				});
				var v = {};
				return W_(u, function(t, e) {
					var n = t.linkGroup;
					n && !f[e] && W_(n.axesInfo, function(e, i) {
						var r = f[i];
						if(e !== t && r) {
							var a = r.value;
							n.mapper && (a = t.axis.scale.parse(n.mapper(a, bc(e), bc(t)))), v[t.key] = a
						}
					})
				}), W_(v, function(t, e) {
					pc(u[e], t, g, !0, d)
				}), yc(f, u, d), xc(p, r, t, o), _c(u, o, n), d
			}
		},
		Y_ = (Al({
			type: "axisPointer",
		...
		Z_ = Pl({
			...
			render: function(t, e, n) {
				...
				Mc("axisPointer", n, function(t, e, n) {
			...
			remove: function(t, e) {
				Ac(e.getZr(), "axisPointer"), Z_.superApply(this._model, "remove", arguments)
			},
			dispose: function(t, e) {
				Ac("axisPointer", e), Z_.superApply(this._model, "dispose", arguments)
			}
		}),
		$_ = Hi(),
		K_ = i,
	...
	Pc.prototype = {
		...
		render: function(t, e, n, i) {
			...
			if(this._axisModel = t, this._axisPointerModel = e, this._api = n, i || this._lastValue !== r || this._lastStatus !== a) {
				...
				} else o = this._group = new cf, this.createPointerEl(o, l, t, e), this.createLabelEl(o, l, t, e), n.getZr().add(o);
				zc(o, e, !0), this._renderHandle(r)
			}
		},
		remove: function(t) {
			this.clear(t)
		...
		createPointerEl: function(t, e) {
			var n = e.pointer;
			if(n) {
				var i = $_(t).pointerEl = new qg[n.type](K_(e.pointer));
				t.add(i)
			}
		},
		createLabelEl: function(t, e, n, i) {
			if(e.label) {
				var r = $_(t).labelEl = new Og(K_(e.label));
				t.add(r), Bc(r, i)
			}
		},
		...
		_renderHandle: function(t) {
			if(!this._dragging && this.updateHandleTransform) {
				...
				this._handle || (o = !0, i = this._handle = ka(r.get("icon"), {
					...
					onmousedown: Q_(this._onHandleDragMove, this, 0, 0),
					drift: Q_(this._onHandleDragMove, this),
					ondragend: Q_(this._onHandleDragEnd, this)
				}), n.add(i)), zc(i, e, !1);
				...
				var l = r.get("size");
				_(l) || (l = [l, l]), i.attr("scale", [l[0] / 2, l[1] / 2]), ks(this, "_doDispatchAxisPointer", r.get("throttle") || 0, "fixRate"), this._moveHandleToValue(t, o)
			}
		},
		_moveHandleToValue: function(t, e) {
			Lc(this._axisPointerModel, !e && this._moveAnimation, this._handle, Ec(this.getHandleTransform(t, this._axisModel, this._axisPointerModel)))
		},
		_onHandleDragMove: function(t, e) {
			var n = this._handle;
			if(n) {
				this._dragging = !0;
				var i = this.updateHandleTransform(Ec(n), [t, e], this._axisModel, this._axisPointerModel);
				this._payloadInfo = i, n.stopAnimation(), n.attr(Ec(i)), $_(n).lastProp = null, this._doDispatchAxisPointer()
			}
		},
	...
	}, Pc.prototype.constructor = Pc, Yi(Pc);
	var J_ = Pc.extend({
			makeElOption: function(t, e, n, i, r) {
				var a = n.axis,
					o = a.grid,
					s = i.get("type"),
					l = jc(o, a).getOtherAxis(a).getGlobalExtent(),
			...
			updateHandleTransform: function(t, e, n) {
				var i = n.axis,
					...
					o = jc(r, i).getOtherAxis(i).getGlobalExtent(),
					s = "x" === i.dim ? 0 : 1,
					l = t.position;
		...
		tw = {
			...
			shadow: function(t, e, n) {
				...
				return {
					type: "Rect",
					shape: Xc([e - i / 2, n[0]], [i, r], Uc(t))
				}
			}
		};
	Ux.registerAxisPointerClass("CartesianAxisPointer", J_), _l(function(t) {
		if(t) {
			(!t.axisPointer || 0 === t.axisPointer.length) && (t.axisPointer = {});
			var e = t.axisPointer.link;
			e && !_(e) && (t.axisPointer.link = [e])
		}
	}), wl(Um.PROCESSOR.STATISTIC, function(t, e) {
		t.getComponent("axisPointer").coordSysAxesInfo = vu(t, e)
	}), Sl({
		type: "updateAxisPointer",
	...
	var ew = f,
		nw = to,
		iw = ["", "-webkit-", "-moz-", "-o-"],
		rw = "position:absolute;display:block;border-style:solid;white-space:nowrap;z-index:9999999;";
	$c.prototype = {
		constructor: $c,
		_enterable: !0,
		update: function() {
		...
		show: function(t) {
			...
			var e = this.el;
			e.style.cssText = rw + Zc(t) + ";left:" + this._x + "px;top:" + this._y + "px;" + (t.get("extraCssText") || ""), e.style.display = e.innerHTML ? "block" : "none", this._show = !0
		},
	...
	Pl({
		...
		_initGlobalListener: function() {
			var t = this._tooltipModel,
				e = t.get("triggerOn");
			Mc("itemTooltip", this._api, aw(function(t, n, i) {
		...
		manuallyHideTip: function(t, e, n, i) {
			...
			!this._alwaysShowContent && this._tooltipModel && r.hideLater(this._tooltipModel.get("hideDelay")), this._lastX = this._lastY = null, i.from !== this.uid && this._hide(Qc(i, n))
		},
		_manuallyAxisShowTip: function(t, e, n, i) {
			...
			if(null != r && null != a && null != o) {
				...
				if(s) {
					var l = s.getData(),
						t = Kc([l.getItemModel(a), s, (s.coordinateSystem || {}).model, t]);
		...
		_showAxisTooltip: function(t, e) {
			var n = this._ecModel,
				...
				a = [],
				o = [],
				s = Kc([e.tooltipOption, i]);
			ow(t, function(t) {
				ow(t.dataByAxis, function(t) {
					var e = n.getComponent(t.axisDim + "Axis", t.axisIndex),
						i = t.value,
						r = [];
					if(e && null != i) {
						var s = Hc(i, e.axis, n, t.seriesDataIndices, t.valueLabelOpt);
						f(t.seriesDataIndices, function(a) {
							var l = n.getSeriesByIndex(a.seriesIndex),
								h = a.dataIndexInside,
								u = l && l.getDataParams(h);
							u.axisDim = t.axisDim, u.axisIndex = t.axisIndex, u.axisType = t.axisType, u.axisId = t.axisId, u.axisValue = Ah(e.axis, i), u.axisValueLabel = s, u && (o.push(u), r.push(l.formatTooltip(h, !0)))
						});
						var l = s;
		...
		_showSeriesItemTooltip: function(t, e, n) {
			var i = this._ecModel,
				...
				l = e.dataType,
				h = o.getData(),
				u = Kc([h.getItemModel(s), o, a && (a.coordinateSystem || {}).model, this._tooltipModel]),
				c = u.get("trigger");
			if(null == c || "item" === c) {
		...
		_updatePosition: function(t, e, n, i, r, a, o) {
			...
			if(o && d.applyTransform(o.transform), "function" == typeof e && (e = e([n, i], a, r.el, d, {
				...
				var p = Jc(n, i, r.el, s, l, u ? null : 20, c ? null : 20);
				n = p[0], i = p[1]
			}
			if(u && (n -= id(u) ? h[0] / 2 : "right" === u ? h[0] : 0), c && (i -= id(c) ? h[1] / 2 : "bottom" === c ? h[1] : 0), t.get("confine")) {
		...
		_updateContentNotChangedOnAxis: function(t) {
			...
			return n && ow(e, function(e, i) {
				var r = e.dataByAxis || {},
					a = t[i] || {},
					o = a.dataByAxis || [];
				n &= r.length === o.length, n && ow(r, function(t, e) {
					var i = o[e] || {},
						r = t.seriesDataIndices || [],
						a = i.seriesDataIndices || [];
					n &= t.value === i.value && t.axisType === i.axisType && t.axisId === i.axisId && r.length === a.length, n && ow(r, function(t, e) {
						var i = a[e];
		...
		dispose: function(t, e) {
			sd.node || (this._tooltipContent.hide(), Ac("itemTooltip", e))
		}
	}), Sl({
		type: "showTip",
		event: "showTip",
	...
	}, function() {}), t.version = zm, t.dependencies = Rm, t.PRIORITY = Um, t.init = fl, t.connect = pl, t.disConnect = gl, t.disconnect = fy, t.dispose = vl, t.getInstanceByDom = ml, t.getInstanceById = yl, t.registerTheme = xl, t.registerPreprocessor = _l, t.registerProcessor = wl, t.registerPostUpdate = bl, t.registerAction = Sl, t.registerCoordinateSystem = Ml, t.getCoordinateSystemDimensions = Il, t.registerLayout = Tl, t.registerVisual = Cl, t.registerLoading = kl, t.extendComponentModel = Al, t.extendComponentView = Pl, t.extendSeriesModel = Ll, t.extendChartView = Ol, t.setCanvasCreator = Bl, t.registerMap = El, t.getMap = zl, t.dataTool = py, t.zrender = sp, t.graphic = qg, t.number = av, t.format = cv, t.throttle = Ds, t.helper = ux, t.matrix = Bd, t.vector = Cd, t.color = Kd, t.parseGeoJSON = dx, t.parseGeoJson = vx, t.util = mx, t.List = My, t.Model = Aa, t.Axis = gx, t.env = sd
});